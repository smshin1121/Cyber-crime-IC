---
title: "Action against Cybercrime — Digital Governance"
...
language: en
status: collected
final_url: https://www.coe.int/en/web/digital-governance/cybercrime
text_status: parsed
fetcher: jina
http_status: 200
...
source_page: wiki/sources/2026-04-17_coe-int_action-against-cybercrime-digital-governance.md
...
## ![Image 1](https://static.coe.int/pics/icons/2018/orange/arrow-right-4.svg)The convention on cybercrime

![Image 2](https://www.coe.int/documents/270525007/0/cybercrime.jpg/cf3cb53a-9a76-41fc-ad65-03ac78d80360?t=1725542466203)The Convention on Cybercrime known also as the "[Budapest Convention](https://www.coe.int/en/web/cybercrime/the-budapest-convention)" is regarded as the most comprehensive and coherent international agreement on cybercrime and electronic evidence to date. It serves as a guideline for any country developing domestic legislation on cybercrime and as a framework for international co-operation between State Parties to this treaty.

**The Budapest Convention provides fo**r:
...
* and for efficient international

co-operation.

The Convention is supplemented by a **[First Additional Protocol](https://www.coe.int/en/web/cybercrime/first-additional-protocol) covering the criminalisation of acts of a racist and xenophobic nature** committed through computer systems (ETS 189) and a [Second Additional Protocol](https://www.coe.int/en/web/cybercrime/t-cy-drafting-group) on enhanced international co-operation and disclosure of electronic evidence (CETS 224).

The treaty is open for accession by any country. In fact, under [Article 37](https://www.coe.int/en/web/cybercrime/the-budapest-convention) any State can become a Party by “accession” if the State is prepared to implement the provisions of this treaty. In addition, a State can become a Party by “ratification”: whether becoming a Party through ratification or accession, the end-result is the same. Parties to the Convention can also become Parties to the two Protocols without the need for a further request for accession.

By June 2024, [75 States](https://www.coe.int/en/web/portal/-/budapest-convention-reaches-75-parties) were Parties to the Convention, 2 countries had signed it and [16 countries](https://www.coe.int/en/web/cybercrime/parties-observers) had been invited to accede. These States participate as members (Parties) or observers (signatories or invitees) in the Cybercrime Convention Committee (T-CY).

**[T-CY](https://www.coe.int/en/web/cybercrime/parties-observers) (Cybercrime Convention Committee)**among other things assesses implement-tation of the Convention by the Parties, adopts Guidance Notes or prepares additional legal instruments.

Capacity building programmes – managed by the specialised **Cybercrime Programme Office** of the Council of Europe ([C-PROC](https://www.coe.int/en/web/cybercrime/cybercrime-office-c-proc-)) in Romania – help countries worldwide to build the necessary capacities to implement the Budapest Convention, its protocols or to follow up to recommendations of the [Cybercrime Convention Committee](https://www.coe.int/en/web/cybercrime/tcy).

## ![Image 3](https://static.coe.int/pics/icons/2018/orange/arrow-right-4.svg)Benefits for Parties
...
Morover, **private sector entities** as well are more likely to co-operate with criminal justice authorities of Parties to the Convention given that Parties need to have a domestic legal framework on cybercrime and electronic evidence in place, including the safeguards of [Article 15](https://rm.coe.int/conditions-and-safeguards-under-article-15-of-the-convention-on-cyberc/16808f1e39).
...
## ![Image 4](https://static.coe.int/pics/icons/2018/orange/arrow-right-4.svg)The First Additional Protocol
...
* **Improved awareness**and education about the harms of xenophobic and racist acts committed through computer systems. Morover, The Protocol encourages the implemen-tation of measures to prevent these forms of hate.

The First Additional Protocol was opened for signature on [23 January 2023](https://www.coe.int/en/web/cybercrime/-/save-the-date-international-conference-on-xenophobia-and-racism-committed-through-computer-systems). As of June 2024, 36 States were Parties and a further 10 had signed the First Protocol.

## ![Image 5](https://static.coe.int/pics/icons/2018/orange/arrow-right-4.svg)The Second Additional Protocol

Considering the proliferation of cybercrime and the increasing complexity of obtaining electronic evidence that may be stored in foreign, multiple, shifting or unknown jurisdictions, the powers of law enforcement are limited by territorial boundaries. As a result, only a very small share of cybercrime that is reported to criminal justice authorities is leading to court decisions. As a response, the Second Additional Protocol to the Convention on Cybercrime ([CETS 224](https://www.coe.int/en/web/conventions/full-list?module=treaty-detail&treatynum=224)) provides a **legal basis for disclosure of domain name registration information and for direct co-operation with service providers for subscriber information**, effective means to obtain subscriber information and traffic data, immediate co-operation in emergencies, mutual assistance tools, as well as personal data protection safeguards.
...
The Second Additional Protocol was opened for signature on [12 May 2022](https://www.coe.int/en/web/cybercrime/opening-for-signature-of-the-second-additional-protocol-to-the-cybercrime-convention). As of June 2024, 46 States had signed the Second Protocol and 2 States had ratified it.
...
**T-CY (Cybercrime Convention Committee)**among other things assesses implement-tation of the Convention by the Parties, adopts Guidance Notes or prepares additional legal instruments.
...
Morover, **private sector entities** as well are more likely to co-operate with criminal justice authorities of Parties to the Convention given that Parties need to have a domestic legal framework on cybercrime and electronic evidence in place, including the safeguards of Article 15.
