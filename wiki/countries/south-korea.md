...
2. **Police cybercrime system**: [[knpa-cyber-bureau|경찰청 사이버수사국 dissolved]] in December 2023; functions currently exercised at 사이버수사심의관 (deputy-director) level within 수사국; a re-establishment of 사이버안전국 has been proposed for 2027
...
### [[knpa-cyber-bureau|경찰청 수사국 사이버수사심의관 (KNPA Cyber Investigation Deliberation Officer)]]
See [[knpa-cyber-bureau]] for full profile.
- **Current status (2026-04-10):** Deputy-director-level (심의관) unit within 경찰청 수사국; standalone 경찰청 사이버수사국 was **dissolved in December 2023**
- Previously established as 사이버안전국 (2014-08), renamed 사이버수사국 (2021-01 upon NIO creation), dissolved (2023-12)
- Primary operational agency for cybercrime investigation; houses INTERPOL NCB Korea function for cyber matters
- Participates in INTERPOL operations (HAECHI series) and Budapest Convention Art. 35 24/7 network
- **Re-establishment of 사이버안전국 pending** (proposed April 2026, expected implementation no earlier than March 2027)

### 법무부 국제형사과 (MOJ International Criminal Affairs Division)
- **Central authority** for MLAT requests and extradition under the Act on International Judicial Mutual Assistance in Criminal Matters
- Processes incoming and outgoing MLA requests
- Coordinates with prosecutors for execution
- Note: the prior version of this page incorrectly linked this unit to [[spo-international-cooperation]]; these are distinct units — the MOJ 국제형사과 is the formal central authority, while the SPO 국제협력단/담당관실 is the prosecutor-side operational counterpart

### [[supreme-prosecutors-office-korea|대검찰청 (Supreme Prosecutors' Office)]] — being dissolved 2026-10-02
- **Current status (through 2026-09-30):** Executes MLA requests operationally; houses 국제협력담당관실 and APC-HUB Secretariat
- **2026-10-02:** **Abolished** and split into 공소청 (under 법무부, prosecution only) and 중대범죄수사청/중수청 (under 행정안전부, investigation of six serious-crime categories including cybercrime)
- Specialized cyber prosecution units historically included 사이버·기술범죄수사부 and NDFC (국가디지털포렌식센터, est. 2008)
- See [[supreme-prosecutors-office-korea]] and [[spo-international-cooperation]] for full profiles and successor-body analysis

### 중대범죄수사청 / 중수청 (Serious Crimes Investigation Agency) — effective 2026-10-02
- Under **행정안전부 (Ministry of the Interior and Safety)**
- Responsible for investigation of six serious-crime categories: **anti-corruption, economic crime, defense-industry crime, narcotics, insurrection/treason, and cybercrime (사이버범죄)**
- First time cybercrime is explicitly designated as a dedicated category for a Korean national-level criminal investigation agency
- Precise division of labor with [[knpa-cyber-bureau|KNPA cybercrime line]] is a major open governance question

### [[kisa|KISA (한국인터넷진흥원)]]
See [[kisa]] for full profile.
- Technical capacity: KrCERT/CC, incident response
- Supports investigations with technical analysis
- International cooperation on incident response (FIRST and APCERT membership)
- **Internal restructuring (2026-01):** AI보안산업본부, 디지털위협예방본부, 랜섬웨어대응팀 newly created in response to 2025 large-scale data breaches
- Parent: [[ministry-of-science-and-ict-korea|과학기술정보통신부 (MSIT)]]
...
- What reservations or declarations will Korea make upon formal Budapest Convention ratification?
...
| [8] | 검찰청 78년 만에 사라진다…수사·기소 분리 체제 | 뉴시스 | 2026-03-21 | https://nwww.newsis.com/view/NISX20260321_0003558134 |
...
| [29] | [[2026-05-13_moj-go-kr_overseas-hacking-organisation-leader-extradited-thailand\|Korea MOJ — Korea-Thailand overseas hacking syndicate leader extradition (BTS Jungkook KRW 38B case; Thai OAG + RTP + INTERPOL cooperation)]] | Ministry of Justice (Republic of Korea) | 2026-05-13 | https://www.moj.go.kr/bbs/moj/182/606523/artclView.do |
| [30] | [[2026-04-16_info-gov-hk_counter-cyber-physical-terrorism-joint-exercise-stealthnet\|HK Govt ISD/HKPF — STEALTHNET counter cyber+physical terrorism joint exercise (HK-Macao-SG-KR + INTERPOL, Apr 2026)]] | HKSAR Information Services Department (info.gov.hk) on behalf of HKPF | 2026-04-16 | https://www.info.gov.hk/gia/general/202604/16/P2026041600803.htm |
