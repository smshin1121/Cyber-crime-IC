---
type: operation
title: "Anton Peck (Dark Web Dealer) Enforcement Action"
aliases:
  - "United States v. Anton Peck (Dark Web Dealer)"
case_id: CYB-FUP-077
period: 2
...
target_entity: "Anton Peck (Dark Web Dealer)"
lead_agency: "[[us-doj]]"
...
results:
  ...
  victims_notified: 0
  other:
    - "Defendant-specific follow-on action derived from [[us-v-peck-dark-web]]"
edges:
...
|---|---|---|---|---|
| [1] | Dark Web Drug Dealer Sentenced to 16 Years in Prison | U.S. Drug Enforcement Administration (DEA) | 2022-12-01 | https://www.dea.gov/press-releases/2022/12/01/dark-web-drug-dealer-sentenced-16-years-prison |
