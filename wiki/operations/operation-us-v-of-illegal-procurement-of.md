...
crime_types:
  - "[[online-fraud-ic]]"
target_entity: "Of Illegal Procurement Of"
lead_agency: "[[us-doj]]"
...
results:
  ...
  victims_notified: 0
  other:
    - "Defendant-specific follow-on action derived from [[us-v-of-illegal-procurement-of]]"
edges:
...
related_cases:
  - "[[us-v-of-illegal-procurement-of]]"
related_operations:
...
This domestic-only U.S. follow-on record has been absorbed into the canonical case page [[us-v-of-illegal-procurement-of]]. No visible cross-border mechanism is documented, so it is not treated as a separate international-cooperation operation.
