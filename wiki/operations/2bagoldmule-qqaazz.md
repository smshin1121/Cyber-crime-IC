...
legal_basis:
  ...
  - "domestic money-laundering and cybercrime authorities"
mechanisms_used:
  - "[[europol-jit]]"
  - "[[mlat-process]]"
...
results:
  ...
  other:
    ...
    - "Hundreds of corporate and personal bank accounts used for laundering"
    - "Network processed funds from cybercrime including hacking and fraud"
edges:
  - source_actor: Europol
    target_actor: "Portuguese Judicial Police"
...
Operation 2BaGoldMule, led by Europol and involving 16 countries, dismantled the QQAAZZ criminal network that had laundered tens of millions of euros in criminal proceeds from cybercrime. The network operated since 2016, using hundreds of corporate and personal bank accounts to launder funds stolen through hacking and online fraud. The operation resulted in 20 arrests across multiple countries.
...
- Portuguese Judicial Police (Policia Judiciaria)
- U.S. Department of Justice / FBI
- Spanish National Police
- UK National Crime Agency

**Participating Countries (16):**
Portugal, United States, Spain, United Kingdom, Latvia, Bulgaria, Georgia, Italy, Germany, Switzerland, Poland, Czech Republic, Australia, Sweden, Austria, Belgium

## Results

- **20 arrests** across 16 countries
- QQAAZZ multi-million euro money laundering network dismantled
