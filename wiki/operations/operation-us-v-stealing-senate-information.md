...
crime_types:
  - "[[online-fraud-ic]]"
target_entity: "Stealing Senate Information"
lead_agency: "[[us-doj]]"
...
results:
  ...
  victims_notified: 0
  other:
    - "Defendant-specific follow-on action derived from [[us-v-stealing-senate-information]]"
edges:
  []
...
missing_fields:
  []
related_cases:
  - "[[us-v-stealing-senate-information]]"
related_operations:
  []
...
This domestic-only U.S. follow-on record has been absorbed into the canonical case page [[us-v-stealing-senate-information]]. No visible cross-border mechanism is documented, so it is not treated as a separate international-cooperation operation.
