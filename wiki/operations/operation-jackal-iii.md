---
type: operation
title: "Operation Jackal III"
aliases:
  - "Jackal III"
operation_type: arrest-sweep
status: completed
case_id: CYB-2024-005
period: 3
enforcement_type:
  - arrest
  - asset_freeze
...
Jackal III represents a significant escalation in the international response to Black Axe-linked BEC and financial fraud. The operation built on intelligence and momentum from [[operation-jackal|Operation Jackal]] (May 2023) and Jackal I (2022).
...
- **~300 arrests** across 21 countries
- **400+ additional suspects** identified
- **720+ bank accounts blocked**
- **USD 3 million** seized
- **Notable regional results:**
  - **Argentina:** Dismantled Nigerian-led transnational network after 5-year investigation; 72 arrests, USD 1.2 million in "supernotes" (counterfeit banknotes), ~100 bank accounts frozen
  - **Ireland:** 63 arrested, 17 charged (including 6 juveniles), 17 fake-name bank accounts blocked
  - **Switzerland:** Cocaine seizure, ~EUR 45,000 cash, multiple arrests linked to West African organized crime

## Jackal Series Progression
...
The series shows consistent escalation: 75 → 103 → ~300 arrests, demonstrating increasing enforcement effectiveness.

## Korean Involvement (한국의 참여)

No direct Korean involvement. Black Axe primarily targets victims in Europe, North America, and Africa.

## Contradictions & Open Questions

- Why is it called "Jackal III" when the 2023 operation was simply "Jackal" (not "Jackal II")? Naming convention unclear.
- What are the specific 21 countries participating?
- What is the total cumulative impact of all Jackal series operations?
...
- An Garda Siochana, 2024-07-16: INTERPOL Operation JACKAL / Ireland Operation SKEIN - July 2024.
- Policia Judiciaria, 2024-07-23: PJ participa na fase III da operacao Jackal.
- Associated Press, 2024-07-17: Interpol arrests 300 people in a global crackdown on West African crime groups across 5 continents.
- An Garda Siochana, 2022-10-14: Interpol Operation JACKAL / Ireland Operation Skein - 14th October 2022.

## Operational Timeline

- 2024-04-10: activity or investigation start.
- 2024-08-28: public announcement.
- 2024-07-03: reported enforcement endpoint.
- 2022-10-14: public source coverage from An Garda Siochana.
- 2024-07-16: public source coverage from An Garda Siochana.
- 2024-07-17: public source coverage from Associated Press.
- 2024-07-23: public source coverage from Policia Judiciaria.
- 2024-08-28: public source coverage from INTERPOL.
...
- Related legal or operational records: Operation Jackal.
...
- INTERPOL coordinated Operation Jackal III from 10 April to 3 July 2024 across 21 countries on five continents, targeting online financial fraud and the West African organized crime syndicates behind it, particularly Black Axe.
- The operation resulted in approximately 300 arrests, the identification of over 400 additional suspects, the blocking of more than 720 bank accounts, and the seizure of assets worth USD 3 million.
- Black Axe and similar groups are considered responsible for the majority of the world's cyber-enabled financial fraud, with business email compromise (BEC) as a primary crime type.
- Garda published detailed Irish-side figures for Operation Jackal III, including arrests, charges, searches, bank-account blocking and crypto seizures.
