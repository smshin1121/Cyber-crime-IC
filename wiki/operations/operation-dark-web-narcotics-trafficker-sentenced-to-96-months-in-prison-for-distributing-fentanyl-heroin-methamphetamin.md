---
type: operation
title: "Joanna De Alba Dark-Web Narcotics Sentencing Action"
title_ko: "조애나 데 알바 다크웹 마약 유통 선고 조치"
aliases:
...
crime_types:
  - "[[drug-trafficking]]"
target_entity: "Joanna De Alba, also known as RaptureReloaded, in a Wall Street Market narcotics distribution case"
lead_agency: "[[us-doj]]"
...
results:
  ...
  servers_seized: 0
  domains_seized: 0
  cryptocurrency_seized: "Bitcoin and Monero proceeds discussed in sentencing record"
...
According to DOJ and DEA reporting, De Alba sold heroin, fentanyl disguised as oxycodone, methamphetamine, MDMA, cocaine, oxycodone, and methadone over Wall Street Market. The cited releases state that she accepted Bitcoin and Monero, used fake business names and shipping addresses, and relied on the identity of her deceased husband to receive parcels and fund operational logistics.

## Participating Parties

- Lead agency: [[us-doj|U.S. Department of Justice]]
- Investigative partner publicly named: DEA New York Division
- Relevant geography in the public record: [[united-states|United States]], [[mexico|Mexico]], [[canada|Canada]], [[netherlands|Netherlands]]
- Related case: [[dark-web-narcotics-trafficker-sentenced-to-96-months-in-prison-for-distributing-fentanyl-heroin-methamphetamin]]

## Operational Timeline

| Date | Event |
|------|-------|
| 2020-01-02 | EDNY and DEA announce the indictment and arraignment. |
| 2021-04 | DOJ later reports that De Alba pleaded guilty. |
| 2021-11-03 | EDNY and DEA announce a 96-month prison sentence. |

## Results and Impact

| Metric | Detail |
|--------|--------|
| Defendant publicly named | Joanna De Alba |
| Marketplace identified | Wall Street Market |
| Transactions reported | More than 600 |
| Final public stage | Sentencing to 96 months |

## Cooperation Mechanisms Used

This was a domestic U.S. prosecution, but the cited charging record has a cross-border evidence dimension. Investigators publicly linked intercepted drug parcels to the Netherlands and Canada, while the defendant was identified as being from Tijuana, Mexico. That makes the case relevant to the repository's international-cooperation lens even without a public extradition stage.

## Contradictions & Open Questions

- The public releases state that De Alba pleaded guilty in April 2021, but the repository does not yet hold the underlying plea filing.
...
- Related legal or operational records: Dark Web Narcotics Trafficker Sentenced To 96 Months In Prison For Distributing Fentanyl Heroin Methamphetamin.
