---
type: operation
title: "Evgenii Ptitsyn Enforcement Action"
aliases:
  - "United States v. Evgenii Ptitsyn"
case_id: CYB-2024-230
period: 3
...
results:
  ...
  victims_notified: 0
  other:
    - "Defendant-specific follow-on action derived from [[us-v-evgenii-ptitsyn]]"
edges:
...
This domestic-only U.S. follow-on record has been absorbed into the canonical case page [[us-v-evgenii-ptitsyn]]. No visible cross-border mechanism is documented, so it is not treated as a separate international-cooperation operation.
