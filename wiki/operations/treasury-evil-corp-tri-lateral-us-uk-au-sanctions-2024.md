...
aliases:
  ...
  - "Treasury JY-2623"
  - "OFAC Evil Corp October 2024 designations"
  - "US-UK-AU Evil Corp expansion sanctions"
  - "Aleksandr Ryzhenkov BitPaymer indictment unsealed"
...
participating_agencies:
  ...
  - "[[uk-nca]]"
legal_basis:
  - "Executive Order 13694 (2015), as amended by E.O. 13757 (December 28, 2016)"
  - "Executive Order 14024 (April 15, 2021) — Russian harmful foreign activities sanctions"
mechanisms_used:
  - "[[asset-freezing]]"
results:
  arrests: 0
  ...
  victims_notified: 0
  other:
    - "OFAC: 7 individuals designated (Eduard Benderskiy; Viktor Grigoryevich Yakubets; Aleksandr Viktorovich Ryzhenkov; Sergey Viktorovich Ryzhenkov; Aleksey Yevgenevich Shchetinin; Beyat Enverovich Ramazanov; Vadim Gennadievich Pogodin)"
...
Evil Corp is a Russia-based cybercriminal organization responsible for the development and distribution of the **Dridex** banking-trojan malware. Per Treasury, Dridex was used to harvest login credentials from hundreds of banks and other financial institutions in over 40 countries, resulting in more than **$100 million in theft losses** to U.S. and international financial institutions and their customers. On December 5, 2019, OFAC designated Evil Corp, its leader Maksim Viktorovich Yakubets, and over a dozen members, facilitators, and affiliated companies under [[asset-freezing|E.O. 13694, as amended by E.O. 13757]]; concurrently, DOJ indicted Maksim Yakubets and Evil Corp administrator Igor Turashev (see [[us-v-yakubets-dridex]] and [[operation-us-v-yakubets-dridex]]). The Department of State's Transnational Organized Crime Rewards Program issued a $5 million reward for Maksim's capture. In October 2022, OFAC designated the **Russian National Engineering Corporation (NIK)** and its principals **Igor Yuryevich Chayka** and **Aleksei Valeryavich Troshin** under E.O. 14024 — Maksim Yakubets had used his employment at NIK as cover for ongoing Evil Corp activity.

The October 1, 2024 action — JY-2623 — is the next iteration of this 5-year sanctions chain, expanding the designation perimeter to include (i) Maksim's father-in-law and key state-nexus enabler Eduard Benderskiy and his two consulting companies, (ii) Maksim's father Viktor, and (iii) five additional operational members and affiliates including the second-in-command Aleksandr Ryzhenkov.
...
- **2013** — Maksim Yakubets and Aleksandr Ryzhenkov begin working together in the "Business Club" group; partnership endures into Evil Corp.
- **2016** — Aleksandr Ryzhenkov ("Guester") seeks internet bots in an Evil Corp operation targeting Switzerland-based victims.
- **mid-2017** — Aleksandr Ryzhenkov targets a New York-based bank; he is described as "interlocutor for Maksim with most of the Evil Corp members."
- **2019 (May)** — Eduard Benderskiy uses his connections to facilitate a business deal involving Maksim and Dmitry Kozak that they expected to earn tens of millions of dollars per month.
...
- **Russia as safe haven.** Per the press release, Benderskiy used his FSB-Spetsnaz background and Russian Duma adjacency to "protect the group, including his son-in-law, both by providing senior members with security and by ensuring they were not pursued by Russian internal authorities." Russia is *almost certainly not* going to extradite or prosecute the designees domestically.
- **No physical-custody outcomes from the 2024 action.** Unlike a takedown that produces arrests, this action's enforcement weight is financial / reputational; physical custody depends on third-country travel by the designees, which is a low-probability event given Russian-state shielding.
- **Sanctions-evasion via rebrand.** Independent open-source analysis (Chainalysis, October 2024) reports that Evil Corp had previously used LockBit affiliate operations as a rebrand to evade the December 2019 sanctions; this rebrand pattern is a structural challenge for sanctions-only enforcement against ransomware groups.
- **UK / Australia designee enumeration not in JY-2623.** The Treasury press release does not list the 15 UK FCDO designees or the 3 Australia DFAT designees by name; full lists are published by the respective sanctions authorities under separate notices.

## Lessons Learned

- The tri-lateral US-UK-AU same-day designation is *almost certainly* a deliberate template — this action establishes the wiki-recorded precedent that recurs in the 2025 Russian-BPH chain ([[treasury-us-au-uk-zservers-sanctions-2025|Zservers]], [[treasury-aeza-group-bulletproof-hosting-sanctions-2025|Aeza]], [[treasury-us-au-uk-sanctions-media-land-russian-bulletproof-hosting-2025|Media Land]]).
- **Iterated sanctions chains** (here, 2019 → 2022 → 2024 over 5 years) are *likely* the standard operating mode for OFAC pressure on Russia-based ransomware groups: each iteration adds personnel, entities, and authority bases as evidence develops.
- **Dual-authority designation** (E.O. 13694 + E.O. 14024 on the same person) is a *highly likely* deliberate engineering choice to lock in both predicates and narrow OFAC-list-removal pathways.
- **Designate + charge** combinations (OFAC designation + concurrent DOJ indictment unsealing of a designee) maximize legal pressure: financial-system exclusion plus a criminal-justice predicate that activates on any future change in the designee's protection status.
- Sequencing a sanctions announcement with a Counter Ransomware Initiative summit day is *highly likely* a deliberate political amplification choice.
...
The Treasury press release JY-2623 does **not** name South Korea as a participating jurisdiction. South Korea is *not* a designating party in this tri-lateral action.

However, three Korean-relevance points are worth recording:

1. **Counter Ransomware Initiative (CRI) coalition member.** South Korea is *almost certainly* a CRI coalition participant (over 50 countries). The October 1, 2024 designation was timed to day 2 of the U.S.-hosted CRI summit, so any CRI-attending Korean officials would have received the announcement in real time as a coalition signal — a normative anchoring effect even without a Korean designating role.
2. **Sanctions-compliance carry-over.** OFAC SDN-list designations have **extraterritorial compliance reach** through U.S.-correspondent-banking channels. Korean financial institutions (특히 미국 달러 결제망에 노출된 국내 은행) must screen against the new SDN entries and avoid transactions with the 7 individuals and 2 entities — this is a routine but important spillover effect for Korean compliance officers (한국 금융기관 제재 컴플라이언스).
3. **Ransomware-as-IC-priority normative alignment.** The CRI summit framing positions ransomware as a coalition-priority threat. South Korea has its own ransomware enforcement track (e.g., domestic Lazarus / DPRK-attributed cases) that aligns with the CRI normative posture, although Evil Corp / Russia-based ransomware is *not* a high-frequency named threat in Korean public enforcement materials at the time of this action.
