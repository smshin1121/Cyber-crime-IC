...
results:
  ...
  servers_seized: 0
  domains_seized: 0
  cryptocurrency_seized: "USD 16 million (from crypto wallets)"
...
The HAECHI series, led by [[south-korea|South Korea]], continues targeting seven types of cyber-enabled financial crime. HAECHI VI builds on the momentum of five previous iterations with increasing financial recovery amounts.

## HAECHI Series Progression

| Operation | Year | Countries | Arrests | Recovered |
|-----------|------|-----------|---------|-----------|
...
- **40 countries and territories** participating

## Results and Impact

- **USD 439 million** recovered (new series record)
- **68,000+ bank accounts** blocked
- **~400 cryptocurrency wallets** frozen
- **USD 16 million** recovered from crypto wallets

### Notable Sub-Operations

1. **Korea-UAE (BEC recovery):** [[knpa-cyber-bureau|KNPA]] worked with Emirati authorities to recover **KRW 6.6 billion (USD 3.91 million)** sent to an illegitimate bank account in Dubai after a Korean steel company discovered forged shipping documents. Rapid communication via I-GRIP enabled **full recovery**.

2. **Thailand (BEC):** Royal Thai Police seized **USD 6.6 million** in stolen assets — the largest single-case recovery in Thailand — involving a transnational organized crime group of Thai and West African nationals that deceived a major Japanese corporation.

3. **Portugal (social security fraud):** 45 suspects arrested for illegally accessing social security accounts, resulting in **EUR 228,000 (USD 270,000)** stolen from 531 victims.

## Korean Involvement (한국의 참여)

Korea continues as the **lead country** of the HAECHI series. In HAECHI VI:
- Korea initiated and led the operation
- **Korea-UAE sub-operation** demonstrated I-GRIP effectiveness: Korean steel company defrauded through forged shipping documents, with USD 3.91 million fully recovered from Dubai
- Korea's leadership of all six HAECHI iterations (2020-2025) is *almost certainly* the most sustained example of a non-Western country leading a major INTERPOL cybercrime operation series
