...
**Modus operandi (compromised-merchant-account internet fraud + adjacent real-estate fraud).** Investigations were initiated in **August 2023** by the **Zentralstelle Cybercrime Bayern (ZCB)** of the **Generalstaatsanwaltschaft Bamberg** in conjunction with the **Polizeipräsidium Mittelfranken / Kriminalpolizei Nürnberg**, targeting an internationally operating internet-fraud organised-crime group. The OCG's primary fraud vehicle was **merchant-account compromise on legitimate online marketplaces and platforms**: the operators hijacked at least **120 existing merchant accounts** (the cited release does not name specific platforms), then used the legitimate-looking storefronts to **list goods for sale at attractive prices**, induce customer orders, and **redirect payments to network-controlled accounts** rather than fulfilling the goods. The induced order volume was approximately **EUR 110 million** in aggregate. The OCG additionally ran an **adjacent real-estate fraud line** against at least 7 victims, suggesting reuse of the same money-mule and account-laundering infrastructure for offline fraud types.

**Victim profile and impact.** **381 identified victims** suffered confirmed losses of approximately **EUR 192,000** for undelivered goods. The gap between the EUR 110 million induced-order volume and the EUR 192,000 confirmed-loss figure (a ~0.17% loss-realisation rate) reflects **platform-side anti-fraud interception** — most orders were flagged, held, or refunded by the marketplaces before payment disbursement reached the network-controlled accounts. Only the **disbursement-completion subset** materialised as confirmed victim loss. The 381 victims are not enumerated by member state in the cited Bavarian Polizei release, but the EU-internal scope of the JIT (Germany + Austria + Romania) and the cross-EU nature of the targeted marketplaces imply a cross-EU victim cohort. An additional **7 real-estate-fraud victims** suffered approximately **EUR 17,000** in losses (small per-victim losses suggesting deposit-style fraud rather than full-sale fraud). Aggregate combined victim losses across both fraud lines: approximately **EUR 209,000**.

**Financial flow.** Inflows: customer order payments (presumably via card / SEPA bank transfer / marketplace-escrow disbursement) redirected from the legitimate compromised merchant accounts to **network-controlled accounts** (the cited release does not enumerate the receiving-bank jurisdictions). Real-estate-fraud inflows: deposit-style payments from the 7 real-estate-fraud victims. Disbursement / laundering: the cited release explicitly invokes **money-mule and account-laundering layers** as the OCG's downstream infrastructure, with **approximately EUR 70,000 cash seized** on the action day (i.e. cash that remained in the OCG's physical possession after most of the proceeds had been moved through the mule layers). The very small per-victim loss × the platform-interception filter × the mule-layer obfuscation produces a fraud-yield profile where the OCG monetises only a small fraction of induced order volume but at high operational frequency.

**Criminal organisation structure.** The OCG is a **7-person identified group of male suspects aged 22-38**, distributed across **three discrete EU jurisdictions** as a **distributed-cells variant** rather than a centralised call-centre structure: cells in **Tirol (Austria), Bukarest and Râmnicu Vâlcea (Romania), and the Regensburg area (Bayern, Germany)**. The 13 simultaneous search locations across the three countries map to this distributed-cell topology. **5 of 7 identified suspects were arrested** on the 2024-12-17 action day; the remaining 2 are not described as fugitive in the cited release but are unarrested as of release date. Suspect nationalities are not enumerated per-suspect in the cited release. The Bayern-Tirol-Romania OCG profile contrasts with the centralised-call-centre OCG pattern recorded in [[romania-moldova-phishing-laundering-jit-2025|the Romania-Moldova phishing-laundering JIT]]: rather than a single physical base concentrating operators, this OCG distributes operators across multiple EU member states, requiring multiple simultaneous domestic warrant executions rather than a single foreign-LE-led raid.
...
- **L26 gap notes**: (a) Suspect nationalities and per-suspect role assignments within the 7-person OCG (cell-lead / mule-recruiter / marketplace-account-compromise specialist / treasury) are not enumerated. (b) Specific online marketplaces / platforms whose merchant accounts were compromised are not named. (c) Receiving-bank jurisdictions for the redirected payment inflows and the cryptocurrency component (if any) of the laundering layers are not enumerated in the cited release.
