...
crime_types:
  - "[[online-fraud-ic]]"
target_entity: "U.S.-Based Conspirators Sentenced To Prison For International Tax Scheme"
lead_agency: "[[us-doj]]"
...
results:
  ...
  victims_notified: 0
  other:
    - "Defendant-specific follow-on action derived from [[u-s-based-conspirators-sentenced-to-prison-for-international-tax-scheme]]"
edges:
...
summary: "This domestic-only U.S. follow-on record has been absorbed into the canonical case page [[u-s-based-conspirators-sentenced-to-prison-for-international-tax-scheme]]. No visible cross-border mechanism is documented, so it is not treated as a separate international-cooperation operation."
created: 2026-04-18
updated: 2026-04-25
---
## Summary
