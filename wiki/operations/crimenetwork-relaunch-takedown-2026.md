...
**Modus operandi.** "Crimenetwork" — both in its original (pre-Dec 2024) and relaunched (Jan 2025 – May 2026) incarnations — was a German-language **Tor-hidden-service** (.onion) escrow/listing marketplace serving the DACH-region *Underground Economy*. The technical architecture follows the standard darknet-marketplace pattern: pseudonymous buyer/vendor accounts, vendor pays monthly **advertising and selling licence fees** to operate a storefront, vendor's listings are categorised across the platform's product taxonomy (stolen data — credentials, payment-card dumps, full identity packages; narcotics; **forged identity documents** — passports, residence permits, drivers' licences), buyer transacts via platform-held escrow, and platform retains a **commission on completed sales**. Settlement currencies: **Bitcoin (BTC)**, **Litecoin (LTC)**, and **Monero (XMR)** — Monero is the privacy-coin default for the most sensitive transactions. The relaunched platform's infrastructure was, per the *politia.md* (Republic of Moldova) press release of 12 May 2026, **hosted on servers of a Moldovan company**, which is what brought the Moldovan INI–PCCOCS into the joint investigation. The platform delivered the same UX and brand identity as the pre-takedown Crimenetwork (intentional brand-revival to capture the prior user base), with the present 35-year-old German national operator standing up the new infrastructure within days of the December 2024 takedown.

**Victim profile and impact.** Victim classes flow from the product taxonomy: (1) **stolen-data victims** — individuals whose credentials, payment-card data, or full identity packages were trafficked through the platform (downstream exposure to account-takeover, payment fraud, synthetic-identity fraud); (2) **forged-document customer-victims and downstream victims** — the forged ID/passport buyers themselves (criminal users), plus downstream victims of fraud schemes facilitated by those documents (e.g. benefits fraud, financial-account fraud, illegal immigration smuggling); (3) **narcotics end-users** as a public-health harm class. The cited BKA/ZIT release does not enumerate individual-victim casualty counts; the harm vector is implicit from the **22,000+ user** scale and the **€3.6 million+ documented turnover** over a ~16-month operating window (Jan 2025 – May 2026). The predecessor (pre-Dec 2024) Crimenetwork generated the **€10 million+ confiscation order** issued in March 2026 by Landgericht Gießen against its admin, indicating the order-of-magnitude of cumulative harm across both incarnations.

**Financial flow.** Buyer crypto into platform-held escrow → vendor ships product (or delivers digital goods) → buyer releases escrow → platform retains **commission** + **monthly licence fees** from vendors → operator extracts net as personal income, layered through multi-coin wallets (BTC/LTC/XMR). The 6 May 2026 action-day seizure totalled **EUR 194,000** in directly-attributable assets (BTC + LTC + XMR ecosystem) — small relative to the **€3.6M+** documented platform turnover, indicating that the bulk of historical flow had already been off-ramped or laundered. The cited release does not enumerate per-coin breakdown, fiat off-ramp jurisdiction, or specific wallet/exchange identifiers.

**Criminal organization structure.** The relaunched Crimenetwork was operated by a **single administrator** (the arrested 35-year-old German national, residing on Mallorca, Spain) — a deliberately minimal-footprint operator profile distinct from the multi-role moderator/admin teams seen on larger international darknet markets. The **100+ vendor accounts** represent the vendor cohort that paid recurring fees for storefront privileges, organized as independent sellers operating under platform-enforced rules; this is a *vendor-licensee* model rather than a vertically-integrated criminal organization. The predecessor Crimenetwork (pre-Dec 2024) was operated under a different administrator now sentenced to **7 years 10 months** by Landgericht Gießen (March 2026, judgment not yet legally final), with a confiscation order of **over €10 million** — demonstrating the operator-as-sole-principal pattern that the German § 127 StGB regime targets. The Polizeipräsidium Offenburg and Polizeipräsidium Reutlingen parallel proceedings, plus the Generalstaatsanwaltschaft Karlsruhe commercial-fraud line, suggest additional German-side suspects beyond the Mallorca operator are under separate investigation.
...
- **L26 gap — Individual victim enumeration:** The cited BKA/ZIT release does not enumerate stolen-data victim counts (how many compromised credentials/cards/identity packages were trafficked), forged-document downstream-victim counts, or narcotics-end-user casualty data; harm is implicit from the 22,000+ user scale and €3.6M+ turnover.
- **L26 gap — Financial off-ramp:** Per-coin breakdown of the €194,000 seizure (BTC vs LTC vs XMR), fiat off-ramp jurisdictions, and laundering venues for the bulk of historical platform turnover are not enumerated in the cited tier-1 source.
