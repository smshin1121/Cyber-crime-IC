...
crime_types:
  - "[[online-fraud-ic]]"
target_entity: "Nigerian citizen, extradited from the U.K., arraigned on indictment for wire fraud involving stolen tax information"
lead_agency: "[[us-doj]]"
...
results:
  ...
  victims_notified: 0
  other:
    - "Defendant-specific follow-on action derived from [[nigerian-citizen-extradited-from-the-u-k-arraigned-on-indictment-for-wire-fraud-involving-stolen-tax-informati]]"
edges:
...
related_cases:
  - "[[nigerian-citizen-extradited-from-the-u-k-arraigned-on-indictment-for-wire-fraud-involving-stolen-tax-informati]]"
related_operations:
