---
type: operation
title: "Robert Merkle Enforcement Action"
aliases:
  - "United States v. Robert Merkle"
case_id: CYB-2022-577
period: 2
...
results:
  ...
  victims_notified: 0
  other:
    - "Defendant-specific follow-on action derived from [[us-v-robert-merkle]]"
edges:
...
This domestic-only U.S. follow-on record has been absorbed into the canonical case page [[us-v-robert-merkle]]. No visible cross-border mechanism is documented, so it is not treated as a separate international-cooperation operation.
