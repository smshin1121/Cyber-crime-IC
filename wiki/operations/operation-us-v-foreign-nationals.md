---
type: operation
title: "Foreign Nationals Enforcement Action"
aliases:
  - "United States v. Foreign Nationals"
case_id: CYB-FUP-428
period: 3
...
crime_types:
  - "[[online-fraud-ic]]"
target_entity: "Foreign Nationals"
lead_agency: "[[us-doj]]"
...
results:
  ...
  victims_notified: 0
  other:
    - "Defendant-specific follow-on action derived from [[us-v-foreign-nationals]]"
edges:
  []
...
This domestic-only U.S. follow-on record has been absorbed into the canonical case page [[us-v-foreign-nationals]]. No visible cross-border mechanism is documented, so it is not treated as a separate international-cooperation operation.
