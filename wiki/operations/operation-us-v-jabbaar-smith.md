---
type: operation
title: "Jabbaar Smith Enforcement Action"
aliases:
  - "United States v. Jabbaar Smith"
case_id: CYB-2018-317
period: 1
...
results:
  ...
  victims_notified: 0
  other:
    - "Defendant-specific follow-on action derived from [[us-v-jabbaar-smith]]"
edges:
...
summary: "This domestic-only U.S. follow-on record has been absorbed into the canonical case page [[us-v-jabbaar-smith]]. No visible cross-border mechanism is documented, so it is not treated as a separate international-cooperation operation."
created: 2026-04-18
updated: 2026-04-25
---
## Summary

This domestic-only U.S. follow-on record has been absorbed into the canonical case page [[us-v-jabbaar-smith]]. No visible cross-border mechanism is documented, so it is not treated as a separate international-cooperation operation.
...
|---|---|---|---|---|
| [1] | Social Services Director of a Nursing Home Charged with ID Theft from Elderly Residents | US DOJ USAO | 2018-03-29 | https://www.justice.gov/usao-edmo/pr/social-services-director-nursing-home-charged-id-theft-elderly-residents |
