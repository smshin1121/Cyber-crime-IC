---
type: operation
title: "Pavlo Kharmanskyi (xDedic) Enforcement Action"
aliases:
  - "United States v. Pavlo Kharmanskyi (xDedic)"
case_id: CYB-FUP-052
period: 3
...
target_entity: "Pavlo Kharmanskyi (xDedic)"
...
results:
  ...
  victims_notified: 0
  other:
    - "Defendant-specific follow-on action derived from [[us-v-kharmanskyi-xdedic]]"
edges:
...
summary: "This domestic-only U.S. follow-on record has been absorbed into the canonical case page [[us-v-kharmanskyi-xdedic]]. No visible cross-border mechanism is documented, so it is not treated as a separate international-cooperation operation."
jurisdictions:
  - "[[united-states]]"
organizations:
  - "[[fbi-cyber-division]]"
...
This domestic-only U.S. follow-on record has been absorbed into the canonical case page [[us-v-kharmanskyi-xdedic]]. No visible cross-border mechanism is documented, so it is not treated as a separate international-cooperation operation.
