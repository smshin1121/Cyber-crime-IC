...
- cooperation_type: info_sharing
  direction: directed
  legal_basis: unknown
  source_actor: ORG-NLEA-CHL-PDI
  target_actor: ORG-ILEA-INTERPOL
- cooperation_type: info_sharing
  direction: directed
  legal_basis: unknown
  source_actor: ORG-JUD-ARG-BSAS
  target_actor: ORG-ILEA-INTERPOL
- cooperation_type: joint_investigation
  direction: directed
  legal_basis: unknown
  source_actor: ORG-ILEA-INTERPOL
  target_actor: (12 South American LEAs)
- cooperation_type: technical_assistance
  direction: undirected
  legal_basis: unknown
  source_actor: ORG-IO-UNODC
  target_actor: ORG-ILEA-INTERPOL
- cooperation_type: info_sharing
  direction: undirected
  legal_basis: unknown
  source_actor: Ecuador LEA
...
legal_basis: []
lessons_learned:
- INTERPOL coordination enabled region-wide enforcement across 12 countries simultaneously
- Intelligence sharing from Chile and Argentina as initiators demonstrates bottom-up
  IC model
- Red Notice arrests (7) demonstrate effectiveness of INTERPOL notice system for CSAM
  cases
- Cross-regional Korea-Ecuador cooperation shows CSAM IC extends beyond regional boundaries
mechanisms_used: []
missing_fields:
- arrests_by_country
- devices_seized_count
- servers_seized
- financial_seized
- legal_basis
- individual_country_agency_names
operation_type: arrest-sweep
outcome: success
participating_agencies:
- '[[interpol-igci]]'
- '[[chile-pdi|Chile Cybercrime Unit (PDI)]]'
...
results:
  ...
  indictments: 0
  other:
  - 20 children rescued/safeguarded
  - 18 direct abusers arrested
  - 111 charged with possession/distribution
  - 7 Red Notice subjects arrested
  - Hardware seized across all 12 countries
  servers_seized: 0
  victims_notified: 0
source_count: 0
source_tier: 2
