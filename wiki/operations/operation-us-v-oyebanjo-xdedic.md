---
type: operation
title: "Olakunle Oyebanjo (xDedic) Enforcement Action"
aliases:
  - "United States v. Olakunle Oyebanjo (xDedic)"
case_id: CYB-FUP-073
period: 3
...
timeframe:
  ...
  ongoing: false
crime_type: "[[wire-fraud-statute]]"
target_entity: "Olakunle Oyebanjo (xDedic)"
...
results:
  ...
  victims_notified: 0
  other:
    - "Defendant-specific follow-on action derived from [[us-v-oyebanjo-xdedic]]"
edges:
...
summary: "This domestic-only U.S. follow-on record has been absorbed into the canonical case page [[us-v-oyebanjo-xdedic]]. No visible cross-border mechanism is documented, so it is not treated as a separate international-cooperation operation."
jurisdictions:
  - "[[united-states]]"
organizations:
  - "[[fbi-cyber-division]]"
...
This domestic-only U.S. follow-on record has been absorbed into the canonical case page [[us-v-oyebanjo-xdedic]]. No visible cross-border mechanism is documented, so it is not treated as a separate international-cooperation operation.
