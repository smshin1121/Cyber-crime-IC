...
crime_types:
  - "[[drug-trafficking]]"
target_entity: "Mosses Ramos, Michael Anthony Barquet, Neca Silvestre, Katrina Cazares, and Kayara Zepeda Montero"
lead_agency: "[[us-doj]]"
...
results:
  ...
  victims_notified: 0
  other:
    - "Defendant-specific follow-on action derived from [[us-v-mosses-ramos-michael-anthony-barquet-neca-silvestre-katrina-cazares-and-kayara-zepeda]]"
edges:
...
related_cases:
  - "[[us-v-mosses-ramos-michael-anthony-barquet-neca-silvestre-katrina-cazares-and-kayara-zepeda]]"
related_operations:
