...
results:
  ...
  victims_notified: 0
  other:
    - "Defendant-specific follow-on action derived from [[illinois-man-sentenced-2-years-federal-prison-operating-subscription-based-computer]]"
edges:
...
related_cases:
  - "[[illinois-man-sentenced-2-years-federal-prison-operating-subscription-based-computer]]"
related_operations:
