...
raw_path: raw/press-releases/2024-12-02_interpol-int_operation-haechi-v.md
...
The `raw_path` metadata links this source page to the archived corpus record `raw/press-releases/2024-12-02_interpol-int_operation-haechi-v.md`, preserving traceable review without classifying the page as a placeholder.