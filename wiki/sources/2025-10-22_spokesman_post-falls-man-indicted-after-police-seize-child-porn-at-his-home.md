...
key_findings:
  - "Confirms HSI dark web undercover operation as origin of the investigation"
...
Spokane Spokesman-Review covers the Perpinan indictment with HSI dark-web origin and child rescue detail.

## Relevance to IC

The HSI dark-web undercover operation is the IC-relevant origin of this prosecution. Confirms the dark-web investigative pipeline behind a domestic indictment.
