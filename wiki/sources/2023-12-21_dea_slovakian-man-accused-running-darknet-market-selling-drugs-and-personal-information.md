...
DEA parallel press release announcing the indictment and arrest of Alan Bill of Bratislava, Slovakia, for running Kingdom Market darknet marketplace.

## Relevance to IC

This source provides parallel federal agency confirmation (DEA) for [[operation-us-v-alan-bill]], documenting the international cooperation (Slovakian national arrest at U.S. port of entry) underpinning the prosecution.
