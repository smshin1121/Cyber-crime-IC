...
key_findings:
  - "Confirms dark-web marketplace use and disguised-pill distribution."
...
MyFloridaNews coverage of Bookman's sentencing.

## Relevance to IC

This source provides independent state-level press coverage for [[operation-us-v-bookman-dark-web]].
