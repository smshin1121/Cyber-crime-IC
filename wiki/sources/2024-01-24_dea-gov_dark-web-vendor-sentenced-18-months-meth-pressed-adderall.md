...
author: "DEA San Francisco Field Division"
...
DEA companion press release for the sentencing of dark-web vendor Tony Tan, providing parallel federal-agency confirmation and identifying the DEA + IRS-CI + USPS investigative coalition.

## Relevance to IC

This source provides parallel federal agency (DEA) confirmation for [[operation-us-v-tan-dark-web]].
