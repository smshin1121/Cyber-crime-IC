...
key_findings:
  - "DOL-OIG investigator confirmation"
...
DOL-OIG public posting of the USAO WDWA press release on Sakiru Ambali's guilty plea. Provides additional federal oversight provenance and confirms DOL-OIG as one of the multi-agency investigators (alongside USPS-OIG, SSA-OIG, IRS-CI).

## Relevance to IC

This source provides government report context for [[operation-us-v-fatiu-ismaila-lawal-and-sakiru-olanrewaju-ambali]].
