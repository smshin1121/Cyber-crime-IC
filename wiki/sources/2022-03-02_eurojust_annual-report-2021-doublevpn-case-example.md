...
pages_updated:
  - doublevpn-takedown
key_findings:
  - "Eurojust's annual report revisited DoubleVPN as a model cybercrime case example."
  - "The case example explicitly notes digital intrusion by Dutch authorities and the seizure of servers hosting DoubleVPN content."
...
This annual-report case example is a useful retrospective source because it distills the legal and operational lessons of DoubleVPN after the action day.

## Relevance to IC

For [[doublevpn-takedown]], it is the cleanest public Eurojust text explaining why the case mattered as a judicial-cooperation precedent.
