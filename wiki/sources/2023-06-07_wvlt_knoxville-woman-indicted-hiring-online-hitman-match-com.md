...
key_findings:
  - "Strava fitness-app data used to surveil victim"
...
WVLT Knoxville's local TV coverage of the Sasser indictment, with detail on surveillance methods (Strava) and tooling (voice-disguising).

## Relevance to IC

Local Knoxville confirmation of [[operation-us-v-melody-sasser]] and [[operation-grand-jury-indicts-knoxville-woman-previously-arrested-in-murder-for-hire-plot]].
