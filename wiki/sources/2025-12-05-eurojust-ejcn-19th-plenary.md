...
This source establishes the EJCN as an active, recurring liaison and information-sharing platform administered by [[eurojust|Eurojust]] for cybercrime prosecutors across the EU and select partner states.
...
| Credibility | confirmed (official source) |
| Topic Relevance | 80/100 (institutional cooperation mechanism, no operation outcome) |
| Data Completeness | 65/100 (date, participants, topics; no operational metrics) |
| Verification | Confirms EJCN existence and activity; deeper sourcing required for governance details |

## Key Metrics

- **Plenary number:** 19th
- **Date:** 4-5 December 2025
- **Participating experts:** 62
