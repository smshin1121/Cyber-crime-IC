...
key_findings:
  - "IRS-CI Western Area Cyber Crime Unit credited as investigating agency alongside U.S. Secret Service Cyber Fraud Task Force, FBI, LAPD, LA County DA, and California Highway Patrol — confirms parallel federal agency role."
...
IRS Criminal Investigation public case summary mirroring the USAO C.D. Cal. press release of August 1, 2022. Confirms federal jury conviction of Argishti Khudaverdyan, lists the multi-agency investigative team, and identifies methods (phishing T-Mobile employees, social engineering the IT help desk).

## Relevance to IC

This source provides parallel federal agency confirmation for [[operation-former-owner-of-t-mobile-retail-store-in-eagle-rock-found-guilty-of-committing-25-million-scheme-to-illegally-]] and identifies the IRS-CI / Secret Service / FBI investigative coalition behind the case.
