...
key_findings:
  - "Identifies the group as Artemis Refund Group (ARG)"
...
Fox23 Tulsa coverage of the ARG refund fraud indictment.

## Relevance to IC

Independent local press coverage of [[operation-ten-members-of-international-cyber-fraud-ring-indicted-for-refund-fraud-scheme-targeting-online-retailers]] adding parent-investigation context (Operation Chargeback) and group name (ARG).
