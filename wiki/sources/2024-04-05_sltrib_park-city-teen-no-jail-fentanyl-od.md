...
key_findings:
  - "Detailed timeline from 2016 juvenile case to 2024 federal sentencing."
...
In-depth Salt Lake Tribune feature on Shapard's path from juvenile court to federal sentencing.

## Relevance to IC

Detailed local-Utah longform source for [[operation-us-v-colin-andrew-shapard]].
