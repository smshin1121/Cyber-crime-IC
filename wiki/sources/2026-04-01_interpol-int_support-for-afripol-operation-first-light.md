...
INTERPOL's AFRIPOL partnership page uses [[operation-first-light-2024]] as an example of how regional policing bodies were folded into a global anti-scam campaign. The page is especially useful for the repo because it highlights the multilateral backbone behind First Light 2024 rather than only the arrest and seizure totals.

## Relevance to IC

This source improves [[operation-first-light-2024]] by documenting the regional-organization layer: AFRIPOL, ASEANAPOL, GCCPOL and Europol. That is directly relevant to the project's international-cooperation focus.
