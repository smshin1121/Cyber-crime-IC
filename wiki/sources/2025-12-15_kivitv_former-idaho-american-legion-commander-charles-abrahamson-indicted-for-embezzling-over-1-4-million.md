...
key_findings:
  - "Identifies IRS-Criminal Investigations as the lead investigative agency"
...
KIVI-TV Boise local TV coverage of the Abrahamson indictment with IRS-CI agency attribution.

## Relevance to IC

Domestic financial-fraud case with no IC element; reinforcement is for source-count compliance only.
