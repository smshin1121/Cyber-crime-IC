...
key_findings:
  - "Charging-stage local press for the multi-year Scholl prosecution."
...
Observer-Reporter charging-stage coverage establishing the long timeline of Scholl's prosecution.

## Relevance to IC

Multi-year local press track for [[operation-one-defendant-sentenced-to-prison-and-another-ordered-detained-pretrial-this-week-in-separate-cyberstalking-ca]].
