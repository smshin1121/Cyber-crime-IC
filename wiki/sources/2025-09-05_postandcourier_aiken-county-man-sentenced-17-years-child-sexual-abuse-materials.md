...
key_findings:
  - "Identifies defendant: Adam Sloan, 40, of Jackson SC"
...
Post and Courier / Aiken Standard local SC newspaper coverage of the Sloan sentencing.

## Relevance to IC

This source provides independent local press coverage for [[operation-us-v-adam-sloan]].
