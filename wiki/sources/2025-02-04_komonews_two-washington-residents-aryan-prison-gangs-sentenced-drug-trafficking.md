...
key_findings:
  - "KOMO Seattle local TV report on the Sara Thompson (Bonney Lake) and Michael Warren (Shelton) sentencings."
...
KOMO News local report on the Pierce/Mason County defendants sentenced for Aryan-gang-linked drug trafficking.

## Relevance to IC

This source provides independent press coverage for [[operation-key-member-of-drug-ring-associated-with-aryan-prison-gang-sentenced-to-7-years-in-prison]].
