...
The `raw_path` metadata links this source page to the archived corpus record `raw/press-releases/2017-07-20_dea-gov_alphabay-largest-online-dark-market-shut-down.md`, preserving traceable review without classifying the page as a placeholder.