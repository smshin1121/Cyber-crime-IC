...
Michigan local TV coverage of the Merkle indictment, indicative of the multi-state victim pool.

## Relevance to IC

Multi-state press source for [[operation-us-v-robert-merkle]].
