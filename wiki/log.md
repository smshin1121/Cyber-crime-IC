...
## [2026-05-18] iter 268 L27 backfill milestone 43 | cases sidecars 1005/1225 (+60, 82.0%)
- Batches QH-QS landed. Cases queue: 220 remaining.

## [2026-05-18] iter 267 L27 backfill milestone 42 | cases sidecars 945/1225 (+60, 77.1%)
- Batches PV-QG landed. Cases queue: 280 remaining.
...
## [2026-05-18] iter 264 L27 backfill milestone 39 | cases sidecars 765/1225 (+60, 62.4%)
- Batches OL-OW landed. Cases queue: 460 remaining.
...
## [2026-05-18] iter 261 L27 backfill milestone 36 | cases sidecars 585/1225 (+60, 47.8%)
- Batches NB-NM landed. Cases queue: 640 remaining.

## [2026-05-18] iter 260 L27 backfill milestone 35 | cases sidecars 525/1225 (+60, 42.9%)
- Batches MP-NA landed. Cases queue: 700 remaining.
...
## [2026-05-18] iter 257 L27 backfill milestone 32 | cases sidecars 345/1225 (+60, 28.2%)
- Batches LF/LG/LH/LI/LJ/LK/LL/LM/LN/LO/LP/LQ landed.
- Cases queue: 880 remaining.

## [2026-05-18] iter 256 L27 backfill milestone 31 | cases sidecars 285/1225 (+60, 23.3%)
- Batches KT/KU/KV/KW/KX/KY/KZ/LA/LB/LC/LD/LE landed.
- Cases queue: 940 remaining.
...
- Pages NOT updated (per task instruction: do NOT touch backlinks): country (australia, philippines), organization (australia-afp, philippine-national-police), crime-type (online-fraud-ic, money-laundering-ic, voice-phishing-ic), mechanism (informal-cooperation, search-seizure).
- Key findings:
  - **L24 strict satisfied**: Tier-1 AFP press release (afp.gov.au, 2024-11-26) explicitly names two distinct foreign-LE counterpart agencies — "the PAOCC and NBI" — quoted verbatim by AFP Assistant Commissioner David McLean (Cybercrime Operations). Two cooperating jurisdictions: Australia (AFP) + Philippines (PAOCC + NBI Cyber Crime Division). No adversary/origin/destination state attribution dressed up as cooperation.
  - **Tier-1 publisher strict**: afp.gov.au is a national LE agency domain (Australian Federal Police). Press release published in the AFP News Centre, not via private newswire. Cross-publisher confirmation through AFP follow-up release (2025-04-01) and itnews.com.au, miragenews.com, cyberdaily.au coverage of the same event.
  - **Distinct from existing Operation Firestorm phase**: existing wiki entry [[afp-rtp-bangkok-scam-centre-operation-firestorm-2025]] covers the 2025-06-16 Bangkok phase with Royal Thai Police; this new page covers the November 2024 Manila phase 1 (the first significant Philippine takedown under the umbrella, per AFP's own characterisation). Both phases share the JPC3 Operation Firestorm umbrella but have distinct host LE counterparts and separate enforcement actions.
  - **L23 compliance**: `lead_agency` and `coordinating_body` left empty (per strict rule — PAOCC and NBI Cyber Crime Division do not yet have wiki entity pages, so they cannot be wikilinked; their description is in body prose). `participating_agencies` uses Glob-verified existing wikilinks `[[australia-afp]]` and `[[philippine-national-police]]` only. PAOCC is technically distinct from PNP (it is a separate inter-agency commission under the Office of the President), but PNP is the closest existing canonical wiki entity for the Philippine LE cooperation channel; PAOCC and NBI flagged in source page for future organization-page promotion.
  - **Hard numbers from primary source**: 250+ arrests (190 foreign nationals + 68 Filipino nationals), 300+ computer towers, 1,000+ mobile phones, thousands of SIM cards seized in a single Manila scam-call-centre raid.
  - **Per RULE 0 strict dedup**: Glob-verified absence of `*manila*`, `*paocc*`, `*operation-firestorm-manila*`, `*manila-scam-call-centre*` operation/source files; Grep-verified absence of "Manila boiler", "PAOCC", "26 November 2024 + Manila", "McLean + Manila", "first significant joint takedown of a Philippine scam compound" in wiki/.
- Process notes: WebFetch direct GET on afp.gov.au succeeded without TLS-spoofing escalation; release content captured cleanly. Rejected first candidates (RULE 0 dedup violations): (1) Garda Síochána / Blacksuit ransomware Aug 2025 — already in wiki as `operation-checkmate-blacksuit`; (2) NPA Japan Operation Cyber Guardian Apr 2026 — already in wiki as `operation-cyber-guardian`; (3) Investigation Emily EPPO Mar 2026 — VAT-fraud, fails cyber-IC double filter (L4); (4) Eurojust Albania-Austria call-centres Apr 2026 — already in wiki as `albania-austria-call-centre-investment-fraud-2026`; (5) Operation Hurdler Hong Kong CSAM Apr 2026 — same operation as `cross-border-online-cse-operation-spf-2026`; (6) Operation SECURE INTERPOL — already in wiki as `operation-secure-interpol`; (7) Operation Synergia III — already in wiki; (8) Operation Red Card 2.0 — already in wiki; (9) Project Compass The Com network — already in wiki; (10) LeakBase 2026 takedown — already in wiki; (11) SIMCARTEL Latvia SIM-box — already in wiki as `latvia-sim-box-cybercrime-as-a-service-takedown-2025`; (12) Operation PowerOFF Apr 2026 — already in wiki as `operation-power-off-2026-04`; (13) Operation Endgame Phase 3 Nov 2025 — already in wiki; (14) EPPO Investigation Emily — VAT carousel fraud, fails cyber test; (15) Aeza Group OFAC sanctions — already in wiki; (16) Kok An OFAC sanctions — already in wiki; (17) Zedcex/Zedxion sanctions — Iran sanctions evasion (geopolitical), no foreign-LE partner named, fails L24; (18) Black Axe Switzerland Apr 2026 — already in wiki; (19) Eurojust Romania-Lithuania-Estonia takedown — 2020, not fresh; (20) AFP-RTP Bangkok phase — already in wiki. Settled on AFP-PAOCC-NBI Manila phase 1 (Nov 2024) as the first clean tier-1 candidate with explicit ≥2 LE-jurisdiction cooperation per L24.
...
- Process notes: Iteration 56 used parallel multi-agent harness (3 of 3 successful). Agent C correctly flagged the Romeo Chita date discrepancy in its return; main thread renamed slugs and updated cross-references before backlinker apply. lint also caught and fixed a `[[us-doj]]` vs `[[us-doj]]` wikilink mismatch in the Zservers operation page.
...
- Backlinks applied (orchestrator follow-up): 3 country pages (germany, canada, united-states); 5 agencies (germany-bka, fbi, us-doj, us-dcis, canada-rcmp-federal-policing); 2 crime-types (ddos-ic, cybercrime-infrastructure-ic); mechanisms/informal-cooperation. Note: agent originally used `[[us-doj]]` (thin stub) → orchestrator switched to canonical `[[us-doj]]` for entity normalization (CLAUDE.md rule 19). 8 reference rows appended.
...
## [2026-05-10] ingest | AFP-PAOCC-NBI Manila scam call-centre takedown (Operation Firestorm phase 1, Nov 2024) — iter 138
- Source: raw/press-releases/2024-11-26_afp-gov-au_afp-partners-philippine-authorities-combating-scam-call-centres.md (Australian Federal Police; en).
- Pages created: wiki/sources/2024-11-26_afp_afp-partners-philippine-authorities-manila-scam-call-centre-takedown.md, wiki/operations/afp-paocc-nbi-manila-scam-call-centre-operation-firestorm-2024.md (provisional, source_count=1).
- Pages updated: countries/australia, countries/philippines; agencies australia-afp, philippine-national-police; crime-types/online-fraud-ic + money-laundering-ic + voice-phishing-ic; mechanisms/informal-cooperation + search-seizure.
- Key findings:
  - **4th distinct AFP primary release in wiki** (after iters 121/122/123) — afp.gov.au cementing as multi-source publisher.
  - **Manila phase 1 of Operation Firestorm** — 26 Nov 2024 takedown of Manila-based scam call-centre / boiler-room targeting AU victims; 250+ workers (foreign nationals incl. PRC, VN, ID) recruited into scam-compound work.
  - **First AU-PH scam compound joint takedown in wiki** — connects to existing iter 123 AFP-RTP Bangkok phase (Operation Firestorm umbrella under JPC3, launched Aug 2024).
...
## [2026-05-17] iter 183 enrichment | Bangkok CCIB Fluxstress/Netdowner — added BKA + ZIT joint release as 2nd source
- Mode: CONTENT-ENRICHMENT (source_count 1->2)
- Source: raw/press-releases/2026-04-16_bka-de_operation-poweroff-fluxstress-netdowner-thai-custody.md
- Publisher: Bundeskriminalamt (BKA) + Generalstaatsanwaltschaft Frankfurt am Main / ZIT, tier-1 own-domain bka.de
- Target op: [[bangkok-ccib-fluxstress-netdowner-ddos-as-a-service-german-arrest-2026]] (case_id CYB-2026-175)
- Pages created: wiki/sources/2026-04-16_bka-de_operation-poweroff-fluxstress-netdowner-thai-custody.md
- Pages updated: wiki/operations/bangkok-ccib-fluxstress-netdowner-ddos-as-a-service-german-arrest-2026.md (source_count 1->2; sources list; Operational Timeline +2026-04-16 BKA/ZIT joint PR row; Contradictions & Open Questions: "Specific German agency" resolved to ZIT lead-prosecution + BKA federal-police investigation); wiki/organizations/germany-bka.md (sources list extended with BKA/ZIT joint release backref)
- Key findings: Second tier-1 own-domain release from the cooperating German jurisdiction explicitly corroborating Thai CCIB primary release. BKA+ZIT release confirms (a) the German national in Thai custody is the alleged Fluxstress/Netdowner operator, (b) German arrest warrant grounded in § 127 StGB (commercial/gang criminal trading platform on the internet), (c) 40+ servers linked to the suspect identified and seized, (d) the German lead-prosecution authority is ZIT (Generalstaatsanwaltschaft Frankfurt) with BKA as federal-police investigative partner. Bilateral DE-TH cooperation thus anchored on two independent tier-1 own-domain sources.
- L24 verbatim quote (Meywirth, BKA Director Cybercrime Division): "Dafür setzen wir auch in Zukunft auf eine enge Zusammenarbeit mit unseren internationalen Partnern" / ZIT-Krause: "Hervorzuheben ist die Identifizierung des deutschen Beschuldigten." Two LE jurisdictions explicitly named (Germany + Thailand) with parallel Polish arrests of separate suspects under same PowerOFF umbrella -> L24 strict satisfied.

## [2026-05-17] iter 184 enrichment | Ragnar Locker 11-country takedown — added Eurojust own-domain release as 2nd source
- Mode: CONTENT-ENRICHMENT (source_count 1->2)
- Source: raw/press-releases/2023-10-20_eurojust_major-international-operation-against-ragnar-locker-ransomware-group.md
- Publisher: Eurojust (EU criminal-justice cooperation agency), tier-1 own-domain eurojust.europa.eu
- Target op: [[operation-ragnar-locker-takedown-2023]] (case_id CYB-2023-820)
- Pages created: wiki/sources/2023-10-20_eurojust_major-international-operation-against-ragnar-locker-ransomware-group.md
- Pages updated: wiki/operations/operation-ragnar-locker-takedown-2023.md (source_count 1->2; sources list; results.servers_seized 0->9; results.other extended with Eurojust verbatim figures: 168 victim companies, 9 servers (5 NL + 2 DE + 2 SE), USD 5M-70M ransom range, 6 suspects heard, +October 2022 Canada arrest wave; Participating Parties +named prosecutorial counterparts table (JUNALCO, Staatsanwaltschaft Leipzig, Milan PPO, Kyiv City PPO, etc.); Operational Timeline rewrites Sept 2021 + adds Oct 2022 Canada FR-CA-US arrest; Results section rewritten with Eurojust precision; Contradictions section: server-count and earlier-wave gaps marked RESOLVED)
- Key findings: Second independent tier-1 own-domain attestation of the 16-20 Oct 2023 Ragnar Locker action week from the EU judicial-cooperation agency, complementing the Europol release on the same date. Adds (a) precise numerics absent from Europol: 168 historical victim companies since 2020, 9 servers seized (5 NL + 2 DE + 2 SE), ransom demands USD 5M-70M per victim; (b) previously-undocumented October 2022 second-wave arrest of an additional Ragnar suspect in Canada via FR-CA-US joint action; (c) named prosecutorial counterparts down to the public-prosecutor level for each of ten participating jurisdictions; (d) confirmation that cryptocurrency seizures occurred during the action days (value undisclosed).
- L24 verbatim quote (Eurojust): "An international operation coordinated by France, with the support of Eurojust and Europol, has dealt an important blow to the Ragnar Locker ransomware group. In an action carried out between 16 and 20 October, searches were conducted in three different countries and in total six suspects were heard in the Czech Republic, Spain, Latvia and France." Eleven LE jurisdictions named (CZ-FR-DE-IT-JP-LV-NL-ES-SE-UA-US) -> L24 strict satisfied. Eurojust/Europol are tier-1 intergovernmental org own-domains -> L25 strict satisfied.
- Dedup: searched wiki/sources/ + raw/press-releases/ for any existing Eurojust Ragnar entry; none present. Existing 2023-10-20 entry is the Europol-only release.

## [2026-05-17] iter 187 CONTENT-ENRICHMENT | TraderTraitor / DMM Bitcoin joint attribution - FBI US-side own-domain anchor
- Mode: CONTENT-ENRICHMENT (add 2nd tier-1 own-domain source to existing source_count=1 op)
- Source: raw/press-releases/2024-12-24_fbi-gov_fbi-dc3-npa-tradertraitor-dmm-bitcoin-308m-attribution.md
- Publisher: Federal Bureau of Investigation (FBI) - National Press Office, US-side own-domain anchor (fbi.gov) of the joint FBI + DC3 + NPA Japan public attribution
- Target op: [[tradertraitor-dmm-bitcoin-cryptocurrency-theft-joint-attribution-2024]] (case_id CYB-2024-997) — source_count 1->2
- Pages created: wiki/sources/2024-12-24_fbi-gov_fbi-dc3-npa-tradertraitor-dmm-bitcoin-308m-attribution.md (new tier-1 source page)
- Pages updated: wiki/operations/tradertraitor-dmm-bitcoin-cryptocurrency-theft-joint-attribution-2024.md (source_count 1->2, sources list +1); wiki/sources/_index.md (+1 row); wiki/organizations/fbi.md (+sources list + table row [23]); wiki/organizations/japan-npa.md (+sources list + table row [12])
- Key findings: Second tier-1 own-domain corroboration of the 2024-12-24 joint FBI + DC3 + NPA Japan attribution to TraderTraitor (Lazarus sub-cluster) of the May 2024 DMM Bitcoin USD 308M / 4,502.9 BTC cryptocurrency theft. The two anchors (FBI fbi.gov US-side + NPA Japan npa.go.jp Japan-side) together constitute a true joint-name attribution rather than parallel national statements - the strongest form of bilateral cyber-attribution IC product currently catalogued in the wiki.
- L24 verbatim quote (FBI): "The Federal Bureau of Investigation, Department of Defense Cyber Crime Center, and National Police Agency of Japan alerted the public to the theft of cryptocurrency worth $308 million U.S. dollars from the Japan-based cryptocurrency company DMM by North Korean cyber actors in May 2024." Followed by: "The FBI, National Police Agency of Japan, and other U.S. government and international partners will continue to expose and combat North Korea's use of illicit activities - including cybercrime and cryptocurrency theft - to generate revenue for the regime." Two LE jurisdictions (US + Japan) explicitly cooperating in joint name -> L24 strict satisfied (DPRK = adversary state, correctly excluded from participating_countries on the operation page). FBI and NPA Japan are tier-1 national investigative bureau own-domains -> L25 strict satisfied. No private-wire substitution required.
...
## [2026-05-17] enrich | LabHost PhaaS Takedown 2024 — 2nd tier-1 own-domain (AFP Australia)
- Op: [[labhost-phishing-as-a-service-takedown-2024]] (source_count 1 -> 2)
- 2nd publisher: Australian Federal Police (AFP) — joint release with Victoria Police, Queensland Police Service, NSW Police Force, WA Police Force; release dated 2024-04-18 09:30 AEST; URL: https://www.afp.gov.au/news-centre/media-release/global-sting-sees-australian-offenders-arrested-cybercrime-and-phishing
- L25 tier-1 own-domain class: national-LE agency, own-domain (afp.gov.au); NOT a private commercial wire. AFP is the executing authority for the Australian arm (codename Operation Nebulae) of the 2024-04-14-to-17 international joint action coordinated by Europol J-CAT.
- L24 verbatim cooperation quote (AFP release): "Globally, the Europol-coordinated investigation resulted in 70 simultaneous search warrants executed in multiple countries, to take down the platform's alleged administrators, users and infrastructure. This included the arrest of 37 offenders, including four individuals based in the UK linked to the running of the site, including the original developer of the platform." — explicit acknowledgement of multilateral cooperation (≥2-state IC cooperation satisfied independently of the Europol release).
- AFP-side adds: Operation Nebulae codename for Australian arm; 5 Australian arrests on 2024-04-17 (1 Melbourne + 1 Adelaide on cybercrime, 3 Melbourne on drug); 22 search warrants across 5 states (14 VIC, 2 QLD, 3 NSW, 1 SA, 2 WA); 200+ AFP/state/territory officers; 207 criminal servers taken down by JPC3; 100+ Australian LabHost users identified; 94,000+ Australian victims; AUD 28M Australian harm estimate; LabHost origin attribution (Canada 2021 -> UK/Ireland -> global, with Australia in top-3 user countries); subscription tier "$270/month" (vs. Europol primary "$249 average").
- L23 wikilink-or-empty: lead_agency=[[uk-metropolitan-police]], coordinating_body=[[europol-ec3]] — unchanged, both wikilink-compliant.
- Files: 2 new (raw AFP + source AFP), 1 updated (op page — source_count 1->2 + sources list + aliases adds Operation Nebulae + timeline 2024-04-17 row + Results subsection for Australia + participating-parties Australia row + References [2] row + Contradictions reconciliation of 94k victims and $249/$270 subscription + updated date).
- Lint: HIGH=0 (verified post-edit).

## [2026-05-17] enrich | Black Axe Spain Takedown 2026 — 2nd tier-1 own-domain (Policía Nacional España)
- Op: [[black-axe-spain-takedown-2026]] (source_count 1 -> 2)
- 2nd publisher: Policía Nacional (España) — Comunicación-Prensa release ID 16763, dated 2026-01-09; URL: https://policia.es/_es/comunicacion_prensa_detalle.php?ID=16763
- L25 tier-1 own-domain class: national-police agency, own-domain (policia.es); NOT a private commercial wire. Policía Nacional is the lead arresting authority for the action.
- L24 verbatim cooperation quote (Policía Nacional release): "Agentes de la Policía Nacional, con la colaboración de la policía alemana del Estado de Baviera y el apoyo de EUROPOL, han desarticulado en España una red criminal presuntamente dedicada al ciberfraude que estaba vinculada con la organización criminal Black Axe." — explicit acknowledgement of ≥2-country LE cooperation (Spain + Germany/Bavaria) plus Europol coordination. Matches Europol tier-1 release on participants and figures.
- ES-side adds (vs. Europol): investigation start date (September 2023, ~16-month investigation); judicial authority (Juzgado de Instrucción nº 18 de Sevilla); search-warrant residences (Torreblanca-Sevilla, Los Molares, Montequinto, La Palmilla-Málaga, Barcelona); provisional imprisonment ordered for 4 principal suspects; granular charges (estafa agravada continuada, pertenencia a organización criminal, blanqueo de capitales, falsedad documental, obstrucción a la justicia, tráfico ilícito de vehículos); predicate fraud typology (Man-in-the-Middle / Business Email Compromise); EUR 5,937,589.70 total + EUR 3,211,297.89 within-operation breakdown; 5 vehicles recovered. No contradiction with Europol primary on the 34 arrests / geographic distribution / EUR 119,352 frozen / EUR 66,403 cash seized.
- L23 wikilink-or-empty: lead_agency=[[spain-national-police]], coordinating_body=[[europol-ec3]] — unchanged, both wikilink-compliant.
- Files: 2 new (raw policia-es + source policia-es), 1 updated (op page — source_count 1->2 + sources list + Summary updated for 9 Jan announcement date + Legal Framework adds judicial authority + charges + MITM/BEC note + Timeline adds 2023-09 investigation-open row + 2026-01-09 ES release row + References [2] row + Contradictions reconciliation + updated date).

## [2026-05-17] enrichment | Treasury Evil Corp tri-lateral US-UK-AU sanctions (Oct 1 2024) — adds DOJ OPA companion source
- Op page: [[treasury-evil-corp-tri-lateral-us-uk-au-sanctions-2024]] source_count 1 -> 2
- New tier-1 own-domain source: DOJ Office of Public Affairs, "Russian National Indicted for Series of Ransomware Attacks" (Oct 1 2024), https://www.justice.gov/archives/opa/pr/russian-national-indicted-series-ransomware-attacks
- Files: raw/press-releases/2024-10-01_justice-gov_russian-national-indicted-ransomware-attacks-ryzhenkov.md + wiki/sources/2024-10-01_justice-gov_russian-national-indicted-ransomware-attacks-ryzhenkov.md (new); op page updated (source_count 1->2 + venue correction + Contradictions callout + updated date)
- L24 quote (DOJ release): "In coordination with the unsealing of the indictment, the Treasury Department's Office of Foreign Assets Control announced that Ryzhenkov, along with six other Evil Corp related persons, was added to its list of specially designated nationals. The United Kingdom's National Crime Agency has reported that Ryzhenkov is also a suspected affiliate of LockBit..."
- Venue contradiction resolved: page previously said "DOJ-EDTX" → DOJ OPA release confirms **Northern District of Texas (NDTX)** with FBI Dallas + USAO-NDTX + CCIPS. Corrected throughout (title, target_entity, results.other, body, references) and Contradictions callout added.
- L25 compliance: DOJ OPA = federal-government own-domain (justice.gov). L24 compliance: DOJ release explicitly names OFAC (same-day SDN designation) and UK NCA (LockBit-affiliate reporting). L23 compliance: lead_agency=[[us-treasury]], coordinating_body=[[us-treasury]] unchanged.
