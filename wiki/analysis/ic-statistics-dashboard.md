...
> [!info] 이 페이지의 모든 데이터는 위키에 수집된 98개 작전과 103개 출처 페이지에서 도출되었습니다. 작전 전체 목록은 [[operations/_index]]를 참조하십시오.
...
| 총 출처 수 | 103 (dedicated pages) + Excel 소스 |
...
| 기관 | 71 | 주요 기관 |
| 국가 | 49 | 국가 프로필 |
| 작전 | 98 | 2014-2025 주요 작전 (P1: 21, P2: 18, P3: 43) |
| 메커니즘 | 11 | 공조 메커니즘 |
| 범죄유형 | 10 | 문서화된 범죄유형 |
| 개념 | 11 | 법적 개념 |
| 출처 | 103 | 전용 출처 페이지 |
| 분석 | 1 | 본 대시보드 포함 |
| **총 페이지** | **365** | _index 파일 및 메타파일 제외 |
