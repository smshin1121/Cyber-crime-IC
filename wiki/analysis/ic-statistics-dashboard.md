...
> [!info] 이 페이지의 모든 데이터는 위키에 수집된 108개 작전과 108개 출처 페이지에서 도출되었습니다. 작전 전체 목록은 [[operations/_index]]를 참조하십시오.
...
| Period 3 (2023-2025) | 48 |
| 총 출처 수 | 108 (dedicated pages) + Excel 소스 |
...
| 기관 | 77 | 주요 기관 |
| 국가 | 71 | 국가 프로필 |
| 작전 | 108 | 2014-2025 주요 작전 (P1: 27, P2: 27, P3: 48) |
| 메커니즘 | 14 | 공조 메커니즘 |
| 범죄유형 | 11 | 문서화된 범죄유형 |
| 개념 | 11 | 법적 개념 |
| 출처 | 108 | 전용 출처 페이지 |
| 분석 | 1 | 본 대시보드 포함 |
| **총 페이지** | **413** | _index 파일 및 메타파일 제외 |
