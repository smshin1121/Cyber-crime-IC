...
> [!info] 이 페이지의 모든 데이터는 위키에 수집된 200개 작전과 130개 출처 페이지에서 도출되었습니다. 작전 전체 목록은 `wiki/operations/_index.md`를 참조하십시오.
...
|------|-----|
| 총 작전 수 | 200 |
| Period 1 (2014-2018) | 37 |
| Period 2 (2019-2022) | 41 |
| Period 3 (2023-2025) | 84 |
...
| 조정기관 | 작전 수 | 비고 |
|---------|---------|------|
| Europol / Europol EC3 | 24 | 가장 많은 작전 조정; 랜섬웨어, 봇넷, 사기 포럼 등 |
| INTERPOL / INTERPOL IGCI | 18 | 체포 규모에서 압도적; HAECHI, Jackal, Serengeti 등 |
| DOJ / FBI (미국 주도) | 94 | 기소·압수 중심 |
| AFRIPOL | 3 | 아프리카 공동 조정 |
| Eurojust | 6 | 사법 공조 조정 |
| 양자/기타 (조정기관 없음) | 55 | 한국 양자작전 포함; 단독 기소 다수 |
...
| 기관 | 95 | 주요 기관 |
| 국가 | 84 | 국가 프로필 |
| 작전 | 200 | 2014-2025 주요 작전 (P1: 37, P2: 41, P3: 84) |
| 메커니즘 | 14 | 공조 메커니즘 |
| 범죄유형 | 16 | 문서화된 범죄유형 |
| 개념 | 12 | 법적 개념 |
| 출처 | 130 | 전용 출처 페이지 |
| 분석 | 1 | 본 대시보드 포함 |
| **총 페이지** | **663** | _index 파일 및 메타파일 제외 |
