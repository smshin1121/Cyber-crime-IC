...
> [!info] 이 페이지의 모든 데이터는 위키에 수집된 129개 정본 작전, 27개 follow-on 기록, 609개 출처 페이지에서 도출되었습니다. 작전 전체 목록은 `wiki/operations/_index.md`를 참조하십시오.
...
| 정본 작전 수 | 129 |
| 흡수 follow-on 기록 | 27 |
| 전체 operation 레코드 | 156 |
| Period 1 (pre-2019) | 29 |
| Period 2 (2019-2022) | 26 |
| Period 3 (2023-2025) | 74 |
| Period 4 (repository-coded) | 0 |
| Period 미분류 | 0 |
| 총 출처 수 | 609 (dedicated pages) + Excel 소스 |
...
| 기관 | 146 | 주요 기관 |
| 국가 | 141 | 국가 프로필 |
| 작전 | 156 | 정본 129, 흡수 follow-on 27; P1: 29, P2: 26, P3: 74, P4: 0, 미분류: 0 |
| 메커니즘 | 28 | 공조 메커니즘 |
| 범죄유형 | 25 | 문서화된 범죄유형 |
| 개념 | 15 | 법적 개념 |
| 출처 | 609 | 전용 출처 페이지 |
| 분석 | 109 | 본 대시보드 포함 |
| **총 페이지** | **1255** | _index 파일 및 메타파일 제외 |
