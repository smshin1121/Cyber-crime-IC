...
> [!info] 이 페이지의 모든 데이터는 위키에 수집된 1085개 작전과 1778개 출처 페이지에서 도출되었습니다. 작전 전체 목록은 `wiki/operations/_index.md`를 참조하십시오.
...
|------|-----|
| 총 작전 수 | 1085 |
| Period 1 (2014-2018) | 203 |
| Period 2 (2019-2022) | 218 |
| Period 3 (2023-2025) | 649 |
...
| 기관 | 99 | 주요 기관 |
| 국가 | 94 | 국가 프로필 |
| 작전 | 1085 | 2014-2025 주요 작전 (P1: 203, P2: 218, P3: 649) |
| 메커니즘 | 14 | 공조 메커니즘 |
| 범죄유형 | 23 | 문서화된 범죄유형 |
| 개념 | 14 | 법적 개념 |
| 출처 | 1778 | 전용 출처 페이지 |
| 분석 | 7 | 본 대시보드 포함 |
| **총 페이지** | **4328** | _index 파일 및 메타파일 제외 |
