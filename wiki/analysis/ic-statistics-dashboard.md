...
> [!info] 이 페이지의 모든 데이터는 위키에 수집된 111개 정본 작전, 974개 follow-on 기록, 4784개 출처 페이지에서 도출되었습니다. 작전 전체 목록은 `wiki/operations/_index.md`를 참조하십시오.
...
| Period 미분류 | 0 |
| 총 출처 수 | 4784 (dedicated pages) + Excel 소스 |
...
| 기관 | 143 | 주요 기관 |
| 국가 | 110 | 국가 프로필 |
| 작전 | 1085 | 정본 111, 흡수 follow-on 974; P1: 25, P2: 24, P3: 62, P4: 0, 미분류: 0 |
| 메커니즘 | 27 | 공조 메커니즘 |
| 범죄유형 | 24 | 문서화된 범죄유형 |
| 개념 | 15 | 법적 개념 |
| 출처 | 4784 | 전용 출처 페이지 |
| 분석 | 95 | 본 대시보드 포함 |
| **총 페이지** | **7511** | _index 파일 및 메타파일 제외 |
