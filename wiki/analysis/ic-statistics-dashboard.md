...
> [!info] 이 페이지의 모든 데이터는 위키에 수집된 204개 작전과 130개 출처 페이지에서 도출되었습니다. 작전 전체 목록은 `wiki/operations/_index.md`를 참조하십시오.
...
|------|-----|
| 총 작전 수 | 204 |
| Period 1 (2014-2018) | 44 |
| Period 2 (2019-2022) | 48 |
| Period 3 (2023-2025) | 93 |
...
| 기관 | 95 | 주요 기관 |
| 국가 | 84 | 국가 프로필 |
| 작전 | 204 | 2014-2025 주요 작전 (P1: 44, P2: 48, P3: 93) |
| 메커니즘 | 14 | 공조 메커니즘 |
| 범죄유형 | 16 | 문서화된 범죄유형 |
| 개념 | 12 | 법적 개념 |
| 출처 | 130 | 전용 출처 페이지 |
| 분석 | 1 | 본 대시보드 포함 |
| **총 페이지** | **667** | _index 파일 및 메타파일 제외 |
