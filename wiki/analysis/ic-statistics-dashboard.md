...
> [!info] 이 페이지의 모든 데이터는 위키에 수집된 286개 정본 작전, 27개 follow-on 기록, 840개 출처 페이지에서 도출되었습니다. 작전 전체 목록은 `wiki/operations/_index.md`를 참조하십시오.
...
| 정본 작전 수 | 286 |
| 흡수 follow-on 기록 | 27 |
| 전체 operation 레코드 | 313 |
| Period 1 (pre-2019) | 34 |
| Period 2 (2019-2022) | 48 |
| Period 3 (2023-2025) | 204 |
| Period 4 (repository-coded) | 0 |
| Period 미분류 | 0 |
| 총 출처 수 | 840 (dedicated pages) + Excel 소스 |

### 조정기관별 분포

| 조정기관 | 작전 수 | 비고 |
|---------|---------|------|
| Europol / Europol EC3 | 70 | 가장 많은 작전 조정; 랜섬웨어, 봇넷, 사기 포럼 등 |
| INTERPOL / INTERPOL IGCI | 38 | 체포 규모에서 압도적; HAECHI, Jackal, Serengeti 등 |
| DOJ / FBI (미국 주도) | 32 | 기소·압수 중심 |
| AFRIPOL | 3 | 아프리카 공동 조정 |
| Eurojust | 49 | 사법 공조 조정 |
| 양자/기타 (조정기관 없음) | 94 | 한국 양자작전 포함; 단독 기소 다수 |
...
| 기관 | 152 | 주요 기관 |
| 국가 | 154 | 국가 프로필 |
| 작전 | 313 | 정본 286, 흡수 follow-on 27; P1: 34, P2: 48, P3: 204, P4: 0, 미분류: 0 |
| 메커니즘 | 28 | 공조 메커니즘 |
| 범죄유형 | 25 | 문서화된 범죄유형 |
| 개념 | 15 | 법적 개념 |
| 출처 | 840 | 전용 출처 페이지 |
| 분석 | 109 | 본 대시보드 포함 |
| **총 페이지** | **1678** | _index 파일 및 메타파일 제외 |
