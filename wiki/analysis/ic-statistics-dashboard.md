...
> [!info] 이 페이지의 모든 데이터는 위키에 수집된 114개 정본 작전, 27개 follow-on 기록, 605개 출처 페이지에서 도출되었습니다. 작전 전체 목록은 `wiki/operations/_index.md`를 참조하십시오.
...
| 정본 작전 수 | 114 |
| 흡수 follow-on 기록 | 27 |
| 전체 operation 레코드 | 141 |
| Period 1 (2014-2018) | 24 |
| Period 2 (2019-2022) | 26 |
| Period 3 (2023-2025) | 64 |
| Period 4 (repository-coded) | 0 |
| Period 미분류 | 0 |
| 총 출처 수 | 605 (dedicated pages) + Excel 소스 |
...
| INTERPOL / INTERPOL IGCI | 23 | 체포 규모에서 압도적; HAECHI, Jackal, Serengeti 등 |
| DOJ / FBI (미국 주도) | 13 | 기소·압수 중심 |
| AFRIPOL | 3 | 아프리카 공동 조정 |
| Eurojust | 18 | 사법 공조 조정 |
...
| 기관 | 145 | 주요 기관 |
| 국가 | 111 | 국가 프로필 |
| 작전 | 141 | 정본 114, 흡수 follow-on 27; P1: 24, P2: 26, P3: 64, P4: 0, 미분류: 0 |
| 메커니즘 | 27 | 공조 메커니즘 |
| 범죄유형 | 25 | 문서화된 범죄유형 |
| 개념 | 15 | 법적 개념 |
| 출처 | 605 | 전용 출처 페이지 |
| 분석 | 107 | 본 대시보드 포함 |
| **총 페이지** | **1291** | _index 파일 및 메타파일 제외 |
