...
> [!info] 이 페이지의 모든 데이터는 위키에 수집된 1330개 작전과 1732개 출처 페이지에서 도출되었습니다. 작전 전체 목록은 `wiki/operations/_index.md`를 참조하십시오.
...
| Period 3 (2023-2025) | 793 |
| 총 출처 수 | 1732 (dedicated pages) + Excel 소스 |
...
| Eurojust | 7 | 사법 공조 조정 |
| 양자/기타 (조정기관 없음) | 32 | 한국 양자작전 포함; 단독 기소 다수 |
...
| 기관 | 97 | 주요 기관 |
| 국가 | 85 | 국가 프로필 |
| 작전 | 1330 | 2014-2025 주요 작전 (P1: 239, P2: 282, P3: 793) |
| 메커니즘 | 14 | 공조 메커니즘 |
| 범죄유형 | 23 | 문서화된 범죄유형 |
| 개념 | 14 | 법적 개념 |
| 출처 | 1732 | 전용 출처 페이지 |
| 분석 | 2 | 본 대시보드 포함 |
| **총 페이지** | **4531** | _index 파일 및 메타파일 제외 |
