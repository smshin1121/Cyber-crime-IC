...
> [!info] 이 페이지의 모든 데이터는 위키에 수집된 116개 정본 작전, 974개 follow-on 기록, 4794개 출처 페이지에서 도출되었습니다. 작전 전체 목록은 `wiki/operations/_index.md`를 참조하십시오.
...
| 정본 작전 수 | 116 |
| 흡수 follow-on 기록 | 974 |
| 전체 operation 레코드 | 1090 |
| Period 1 (2014-2018) | 25 |
| Period 2 (2019-2022) | 28 |
| Period 3 (2023-2025) | 63 |
| Period 4 (repository-coded) | 0 |
| Period 미분류 | 0 |
| 총 출처 수 | 4794 (dedicated pages) + Excel 소스 |

### 조정기관별 분포

| 조정기관 | 작전 수 | 비고 |
|---------|---------|------|
| Europol / Europol EC3 | 43 | 가장 많은 작전 조정; 랜섬웨어, 봇넷, 사기 포럼 등 |
...
| 양자/기타 (조정기관 없음) | 14 | 한국 양자작전 포함; 단독 기소 다수 |
...
| 기관 | 145 | 주요 기관 |
| 국가 | 111 | 국가 프로필 |
| 작전 | 1090 | 정본 116, 흡수 follow-on 974; P1: 25, P2: 28, P3: 63, P4: 0, 미분류: 0 |
| 메커니즘 | 27 | 공조 메커니즘 |
| 범죄유형 | 25 | 문서화된 범죄유형 |
| 개념 | 15 | 법적 개념 |
| 출처 | 4794 | 전용 출처 페이지 |
| 분석 | 103 | 본 대시보드 포함 |
| **총 페이지** | **7538** | _index 파일 및 메타파일 제외 |
