...
> [!info] 이 페이지의 모든 데이터는 위키에 수집된 1330개 작전과 1718개 출처 페이지에서 도출되었습니다. 작전 전체 목록은 `wiki/operations/_index.md`를 참조하십시오.
...
|------|-----|
| 총 작전 수 | 1330 |
| Period 1 (2014-2018) | 239 |
| Period 2 (2019-2022) | 282 |
| Period 3 (2023-2025) | 792 |
| 총 출처 수 | 1718 (dedicated pages) + Excel 소스 |

### 조정기관별 분포

| 조정기관 | 작전 수 | 비고 |
|---------|---------|------|
| Europol / Europol EC3 | 56 | 가장 많은 작전 조정; 랜섬웨어, 봇넷, 사기 포럼 등 |
| INTERPOL / INTERPOL IGCI | 36 | 체포 규모에서 압도적; HAECHI, Jackal, Serengeti 등 |
| DOJ / FBI (미국 주도) | 1195 | 기소·압수 중심 |
| AFRIPOL | 3 | 아프리카 공동 조정 |
| Eurojust | 7 | 사법 공조 조정 |
| 양자/기타 (조정기관 없음) | 33 | 한국 양자작전 포함; 단독 기소 다수 |
...
| 기관 | 97 | 주요 기관 |
| 국가 | 85 | 국가 프로필 |
| 작전 | 1330 | 2014-2025 주요 작전 (P1: 239, P2: 282, P3: 792) |
| 메커니즘 | 14 | 공조 메커니즘 |
| 범죄유형 | 23 | 문서화된 범죄유형 |
| 개념 | 14 | 법적 개념 |
| 출처 | 1718 | 전용 출처 페이지 |
| 분석 | 2 | 본 대시보드 포함 |
| **총 페이지** | **4517** | _index 파일 및 메타파일 제외 |
