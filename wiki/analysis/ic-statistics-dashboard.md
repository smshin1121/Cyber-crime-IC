...
> [!info] 이 페이지의 모든 데이터는 위키에 수집된 1330개 작전과 1697개 출처 페이지에서 도출되었습니다. 작전 전체 목록은 `wiki/operations/_index.md`를 참조하십시오.
...
| 총 출처 수 | 1697 (dedicated pages) + Excel 소스 |
...
| 출처 | 1697 | 전용 출처 페이지 |
| 분석 | 2 | 본 대시보드 포함 |
| **총 페이지** | **4484** | _index 파일 및 메타파일 제외 |
