...
> [!info] 이 페이지의 모든 데이터는 위키에 수집된 1216개 작전과 1778개 출처 페이지에서 도출되었습니다. 작전 전체 목록은 `wiki/operations/_index.md`를 참조하십시오.
...
|------|-----|
| 총 작전 수 | 1216 |
| Period 1 (2014-2018) | 223 |
| Period 2 (2019-2022) | 252 |
| Period 3 (2023-2025) | 726 |
| 총 출처 수 | 1778 (dedicated pages) + Excel 소스 |
...
| DOJ / FBI (미국 주도) | 1076 | 기소·압수 중심 |
| AFRIPOL | 3 | 아프리카 공동 조정 |
| Eurojust | 14 | 사법 공조 조정 |
| 양자/기타 (조정기관 없음) | 29 | 한국 양자작전 포함; 단독 기소 다수 |
...
| 카테고리 | 페이지 수 | 비고 |
|---------|---------|------|
| 법적 프레임워크 | 8 | 부다페스트 협약 등 |
| 기관 | 99 | 주요 기관 |
| 국가 | 86 | 국가 프로필 |
| 작전 | 1216 | 2014-2025 주요 작전 (P1: 223, P2: 252, P3: 726) |
| 메커니즘 | 14 | 공조 메커니즘 |
| 범죄유형 | 23 | 문서화된 범죄유형 |
| 개념 | 14 | 법적 개념 |
| 출처 | 1778 | 전용 출처 페이지 |
| 분석 | 5 | 본 대시보드 포함 |
| **총 페이지** | **4461** | _index 파일 및 메타파일 제외 |
