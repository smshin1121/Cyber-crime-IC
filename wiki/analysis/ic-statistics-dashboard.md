...
> [!info] 이 페이지의 모든 데이터는 위키에 수집된 82개 작전과 91개 출처 페이지에서 도출되었습니다. 작전 전체 목록은 [[operations/_index]]를 참조하십시오.
...
| 총 출처 수 | 91 (dedicated pages) + Excel 소스 |
