...
operations_participated:
  ...
  - "[[operation-150-arrested-in-dark-web-drug-bust-as-police-seize-eur-26-million]]"
  ...
  - "[[operation-mastermind-behind-eur-1-billion-cyber-bank-robbery-arrested-in-spain]]"
  - "[[operation-morpheus]]"
  - "[[operation-onymous]]"
  - "[[operation-power-off]]"
...
EC3 is *almost certainly* the most operationally active international coordination body for cybercrime takedowns, having supported or coordinated landmark operations including:
- **[[operation-cronos-phase1|Operation Cronos Phase 1]]** (Feb 2024): Disrupted LockBit ransomware group; 34 servers seized, 2 arrests, decryption keys released
- **[[operation-endgame-phase1|Operation Endgame Phase 1]]** (May 2024): Largest-ever botnet takedown (IcedID, Smokeloader, Pikabot, Bumblebee, Trickbot); 4 arrests, 100+ servers taken down, 2,000+ domains seized
...
EC3 operates under Europol's mandate (EU Regulation 2016/794). It does not have independent investigative powers but supports and coordinates EU member state operations. Key functions:

- **Operational coordination:** Hosting operational meetings, coordination centers during action days
- **Joint Investigation Teams:** Providing logistical, analytical, and financial support for JITs
- **Analysis:** Maintaining databases, cross-matching intelligence across investigations
- **Forensics:** EC3's digital forensics lab supports member states with technical analysis
- **IOCTA:** Annual Internet Organised Crime Threat Assessment

## IC Capabilities

- Operational analysis and cross-matching of data from multiple investigations
- Support for [[europol-jit|Joint Investigation Teams]]
- Hosting of operational coordination centers for multi-country action days
- Connection to 40+ non-EU partner countries through cooperation agreements
- J-CAT (Joint Cybercrime Action Taskforce): Permanent team of liaison officers from member states and partners co-located at EC3

## Key Operations and Cases

EC3 coordinated or supported the following major operations (2024-2025):

| Operation | Date | Type | Results |
|-----------|------|------|---------|
| [[operation-cronos-phase1]] | Feb 2024 | Takedown | 34 servers, 2 arrests, 5 indictments |
| [[operation-endgame-phase1]] | May 2024 | Takedown | 100+ servers, 2,000+ domains, 4 arrests |
| [[operation-cronos-phase3]] | Oct 2024 | Arrest sweep | 4 arrests, 9 servers, sanctions |
| [[phobos-8base-crackdown]] | Feb 2025 | Arrest sweep | 4 arrests, 27 servers, 400+ warned |
| [[operation-endgame-phase2]] | May 2025 | Infrastructure seizure | 300 servers, 650 domains, EUR 3.5M |
| [[qakbot-gallyamov-indictment]] | May 2025 | Joint investigation | Gallyamov indicted; USD 24M+ crypto seized; 7 countries |
| [[franco-israeli-ceo-fraud]] | 2022-2023 | Joint investigation | 8 arrests, EUR 5.5M seized; 7 countries; BEC/CEO fraud |

These operations demonstrate EC3's role as the *almost certainly* indispensable coordination hub for major EU cybercrime operations, particularly against [[ransomware-ic|ransomware]] infrastructure.

## Korean Interactions (한국과의 협력)

Korea has a Strategic Agreement with Europol enabling cooperation. Korean liaison officers and data sharing arrangements facilitate cooperation on cases affecting both Korean and European victims.

The [[phobos-8base-crackdown|Phobos/8Base crackdown]] (2025) is the most directly relevant Europol-coordinated operation for Korea: a Phobos administrator was arrested in South Korea in June 2024 and extradited to the US in November 2024 as part of this Europol-coordinated investigation.

## Contradictions & Open Questions

- How effective is Europol's cooperation with non-EU partners for real-time operational coordination?
- What is the current staffing level and capacity of EC3?
