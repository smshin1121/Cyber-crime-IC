...
key_roles:
  - "Compatibility page for generic German prosecution references in older cybercrime operation records."
  - "Routes cybercrime-specific prosecution context to [[zit-frankfurt]] and [[germany-frankfurt-prosecutor]]."
last_verified: 2026-04-29
mandate: "Legacy compatibility page for generic German prosecutorial references in older operation records."
mechanisms_operated:
  []
member_states: 0
notable_cases:
  []
official_name: "German Prosecution Authorities"
official_name_ko: ""
operations_participated:
  - "[[operation-avalanche]]"
org_type: prosecutorial-authority
...
German Prosecution is retained as an organization node in the international cybercrime cooperation graph. The current mandate field records: Legacy compatibility page for generic German prosecutorial references in older operation records. Country or jurisdiction metadata is recorded as [[germany]]. This page is used for menu navigation, operation back-links, and partner analysis rather than as a complete institutional profile.

## Cooperation Graph Role

Linked operation records: [[operation-avalanche]]. These links are the safest basis for interpreting this organization in the repository because they connect the organization to named enforcement actions, source records, and cooperation mechanisms already present in the corpus. Where an operation page names multiple agencies, this organization page should be read together with the operation's lead agency, coordinating body, participating-country list, and source table.
...
| [2] | [[europol-goznym-takedown|Alias resolved: Goznym Malware Cybercriminal Network Dismantled In International Operation]] | Europol | 2019-05-01 | https://www.europol.europa.eu/media-press/newsroom/news/goznym-malware-cybercriminal-network-dismantled-in-international-operation |
| [3] | [[2026-04-18_justice-gov_avalanche-network-dismantled-international-cyber-operation|Avalanche Network Dismantled in International Cyber Operation]] | US DOJ USAO | 2016-12-05 | https://www.justice.gov/usao-wdpa/pr/avalanche-network-dismantled-international-cyber-operation |
