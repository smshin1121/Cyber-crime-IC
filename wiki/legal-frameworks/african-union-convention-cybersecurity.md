...
source_count: 1
sources:
  - "[[2026-04-17_au-int_malabo-convention-status]]"
...
This page is a compatibility record for the African Union Convention on Cyber Security and Personal Data Protection, commonly called the Malabo Convention.
...
The Convention matters as Africa's regional framework linking cybersecurity, cybercrime, electronic transactions, and personal-data protection. In this wiki it should be read together with [[malabo-convention]], which carries the main treaty analysis.
