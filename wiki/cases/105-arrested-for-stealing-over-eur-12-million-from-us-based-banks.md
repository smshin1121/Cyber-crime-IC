---
type: case
title: "Operation Secreto Arrest Wave"
case_number: "Multi-jurisdictional enforcement action; no single public court docket in repository"
jurisdiction: "International law enforcement action spanning Europe and the United States"
...
crime_charged:
  ...
  - "[[money-laundering-ic]]"
defendants:
  - name: "Operation Secreto suspect network"
    nationality: "Multi-national"
    status: prosecuted
    sentence: ""
    location_at_arrest: "Spain, Greece, Austria, United Kingdom and related jurisdictions"
related_operation: "[[operation-105-arrested-for-stealing-over-eur-12-million-from-us-based-banks]]"
ic_elements:
  mlat_requests: []
  extradition: ""
  evidence_from_abroad: []
  foreign_arrests:
    - "Public releases describe arrests across multiple European jurisdictions."
  asset_freezing:
    - "87 bank accounts worth more than EUR 1.3 million were frozen."
...
key_legal_issues:
  - "[[bank-fraud-ic]]"
  - "[[money-laundering-ic]]"
precedent_value: "Useful as a multi-jurisdictional payment-fraud enforcement record showing how shell companies, card issuance, and laundering can be tackled through Europol-U.S. Secret Service coordination."
source_count: 5
sources:
...
created: 2026-04-18
updated: 2026-04-26
summary: "This case page captures the public arrest and asset-freezing record of Operation Secreto, a transatlantic fraud and laundering investigation targeting shell-company abuse and payment-card fraud against U.S.-based banks."
---
## Summary

This page captures the public arrest and asset-freezing record of **Operation Secreto**, a transatlantic fraud and money laundering investigation targeting shell-company abuse and payment-card fraud against U.S.-based banks.

## Facts

Official releases describe a criminal network that used shell companies in the United States to obtain debit and credit cards after simulating legitimate transaction history. The network then exploited those cards, often through complicit retailers in Spain, and laundered the proceeds through accounts in multiple European countries. Publicly reported enforcement results included 105 arrests, 88 searches, 87 frozen accounts, EUR 406,000 in cash seized, and 14 high-end vehicles seized.

## International Cooperation Elements

This is a strong IC example because the victim institutions were U.S.-based banks while the operational footprint sat largely in Europe. Europol coordinated the action, the U.S. Secret Service co-led, and Spanish police supplied national operational execution, with other European states and U.S. financial-crime actors also named.

## Legal Analysis

The repository does not yet contain the downstream national court dockets for the many suspects, so this page should be treated as an enforcement-stage case record rather than a consolidated judicial case file. Even so, it remains valuable because it documents a concrete cross-border payment-fraud pattern and a mature cooperation model.
...
- 2021-02-01: public source coverage from Europol.
- 2021-02-03: public source coverage from Policía Nacional España, United States Secret Service.
- 2021-02-04: public source coverage from Greek Reporter.
