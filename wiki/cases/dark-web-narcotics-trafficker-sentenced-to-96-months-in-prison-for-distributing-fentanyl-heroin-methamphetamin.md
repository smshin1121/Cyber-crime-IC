---
type: case
title: "United States v. Joanna De Alba"
case_number: "1:19-cr-00563-DLI"
...
defendants:
  - name: "Joanna De Alba"
    ...
    location_at_arrest: "U.S.-Mexico border"
related_operation: "[[operation-dark-web-narcotics-trafficker-sentenced-to-96-months-in-prison-for-distributing-fentanyl-heroin-methamphetamin]]"
ic_elements:
  mlat_requests: []
  extradition: ""
  evidence_from_abroad:
    - "Public charging releases describe intercepted parcels linked to the Netherlands and Canada."
  foreign_arrests: []
  asset_freezing: []
...
key_legal_issues:
  - "[[drug-trafficking]]"
  - "[[online-fraud-ic]]"
precedent_value: "Useful as a dark-web narcotics prosecution involving cryptocurrency payments and publicly described cross-border evidentiary touchpoints."
source_count: 6
sources:
...
This case tracks the EDNY prosecution of Joanna De Alba, also known as `RaptureReloaded`, for selling narcotics over the Wall Street Market dark-web marketplace in exchange for cryptocurrency. The public record shows indictment in January 2020 and sentencing in November 2021 after a guilty plea reported in April 2021.

## Facts

The DOJ and DEA releases describe De Alba as a Wall Street Market vendor who distributed heroin, fentanyl disguised as oxycodone, methamphetamine, MDMA, cocaine, oxycodone, and methadone. The public sentencing narrative says she completed more than 600 transactions, accepted Bitcoin and Monero, and generated proceeds worth more than USD 1 million at later valuations.

## International Cooperation Elements

The prosecution was domestic, but the public charging narrative includes cross-border evidence indicators. Investigators stated that packages linked to the scheme were intercepted en route from the Netherlands and Canada, and De Alba was identified as being from Tijuana, Mexico.
