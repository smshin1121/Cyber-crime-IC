---
type: case
title: "United States v. Olayemi Adafin (xDedic)"
...
precedent_value: "Low - sparse official summary, but useful for documenting unresolved sentencing status within the xDedic fraud branch."
source_count: 1
sources:
  - "[[2024-01-04_mdfl_adafin-xdedic-summary]]"
created: 2026-04-17
updated: "2026-04-29"
summary: "United States v. Olayemi Adafin is an xDedic-related wire-fraud case identified in DOJ's 2024 roundup. Adafin had been convicted but not yet sentenced as of January 4, 2024."
---
> [!note] Sparse source
> DOJ's roundup notes the conviction status and pending sentencing but does not include a full case narrative.

## Summary

United States v. Olayemi Adafin is an xDedic-related wire-fraud case identified in DOJ's 2024 roundup. Adafin had been convicted but not yet sentenced as of January 4, 2024.

## Case Context

This case page preserves a defendant-level or filing-level view for **United States v. Olayemi Adafin (xDedic)**. The current metadata records the posture as `convicted` and links the matter to [[xdedic-marketplace-takedown]]. That distinction matters because case pages can track sentencing, defendant status, charged conduct, jurisdiction, and evidentiary channels at a finer level than an umbrella operation page.
