...
case_number: "Source-derived cluster from Operation Dark HunTOR public reporting"
...
crime_charged:
  ...
  - "[[online-fraud-ic]]"
defendants:
  - name: "Multiple unidentified dark-web vendors and drug traffickers"
    nationality: Unknown
    status: prosecuted
    sentence: ""
    location_at_arrest: ""
related_operation: "[[operation-150-arrested-in-dark-web-drug-bust-as-police-seize-eur-26-million]]"
ic_elements:
  mlat_requests: []
  extradition: ""
...
key_legal_issues:
  - "[[drug-trafficking]]"
  - "[[electronic-evidence]]"
precedent_value: "Useful as an umbrella arrest cluster tied to DarkMarket intelligence exploitation, but not a substitute for named individual dockets."
source_count: 5
sources:
...
This page tracks the multinational arrest wave publicly announced under Operation Dark HunTOR after exploitation of the seized [[darkmarket-takedown|DarkMarket]] infrastructure. Public sources support the operation-wide arrests and seizures but do not identify a full named defendant list.

## Facts

Official sources state that authorities arrested 150 suspected dark-web traffickers across nine countries and seized approximately EUR 26.7 million, 234 kg of drugs and 45 firearms. The enforcement wave followed roughly ten months of intelligence exploitation after German authorities seized DarkMarket infrastructure in January 2021.
...
The core integrity constraint is granularity. The public sources are strong on collective results and weak on a complete list of defendant names, case numbers and sentences. To avoid fabricating or over-aggregating legal outcomes, the page treats the defendants as a collective unidentified target set.
...
- 2021-01-12: public source coverage from Europol.
- 2021-10-26: public source coverage from Europol, US DOJ, US DOJ/DEA.
- 2021-10-27: public source coverage from UK NCA.
...
| 2 | Department of Justice announces results of Operation Dark HunTOR | DEA / DOJ | 2021-10-26 | https://www.dea.gov/ |
| 3 | Deputy AG Lisa Monaco delivers remarks on Operation Dark HunTOR | DOJ | 2021-10-26 | https://www.justice.gov/ |
| 4 | International operation targets dark web drugs marketplace | UK NCA | 2021-10-27 | https://www.nationalcrimeagency.gov.uk/news/international-operation-targets-dark-web-drugs-marketplace |
| 5 | DarkMarket: world's largest illegal dark web marketplace taken down | Europol | 2021-01-12 | https://www.europol.europa.eu/media-press/newsroom/news/darkmarket-world-s-largest-illegal-dark-web-marketplace-taken-down |
